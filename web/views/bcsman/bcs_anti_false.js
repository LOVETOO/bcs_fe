                ...
                $scope.gridOptions = {
                    hcEvents: {
                        cellFocused: function (params) {
                            $scope.data.currItem.short_barcode = $scope.data.currItem.bcs_search_logs[params.rowIndex].short_barcode;
                            //防伪热点图初始化
                            $scope.data.currItem.data = []
                            $scope.data.currItem.geoCoordMap = {}
                            //热点数据
                            var lines = $scope.data.currItem.bcs_search_logs[params.rowIndex].lines;
