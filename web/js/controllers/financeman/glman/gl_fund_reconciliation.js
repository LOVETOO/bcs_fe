        ...
        var controller = [
            ...
            function ($scope, $stateParams) {
                ...
                $scope.data.currItem = {
                    ...
                    search_flag: 2,
                    account_type: numberApi.toNumber($stateParams.fund_account_type) > 0 ?
                        numberApi.toNumber($stateParams.fund_account_type) : 0,  //账户类型：1现金 2银行 0全部
                ...
                $scope.openDetail = function (params) {
                    ...
                    var object_name = params.data.fund_account_name;
                    var fund_account_type = params.data.object_type;
                ...
                $scope.searchByCon = function (openBy) {
                    ...
                    return requestApi.post('gl_account_subject_balance', 'glfndreconciliation', postData)
                        .then(function (data) {
