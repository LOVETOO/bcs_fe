...
function edi_lcquotaapplyinfoUpdate($rootScope, $scope, $location, $modal, $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {
    //设置当前对象名及主键名    银行代码申请查询
    $scope.objconf = {
        classid: "edi_lcquotaapplyinfo",
        key: "corpserialid",
        nextStat: "edi_lcquotaapplyinfo",
    ...
    $scope.headername = "LC限额申请修改";
    $scope.hide=true;
    edi_lcquotaapplyinfoUpdate = HczyCommon.extend(edi_lcquotaapplyinfoUpdate, ctrl_view_public);
    edi_lcquotaapplyinfoUpdate.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
...
//加载控制器
basemanControllers
    .controller('edi_lcquotaapplyinfoUpdate', edi_lcquotaapplyinfoUpdate)
