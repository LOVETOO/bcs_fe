...
function bill_deliver_header($rootScope, $scope, $location, $modal,$timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {
    //设置当前对象名及主键名
    $scope.objconf = {
        classid: "bill_deliver_header",
        key: "deliver_id",
        nextStat: "bill_deliver_headerEdit",
        classids: "bill_deliver_headers",
        sqlBlock:"1=1",
        thead:[],
        grids:[{optionname:'viewOptions', idname:'contains'}]
    };
    $scope.headername="商用发货明细录入";
    /*********************系统词汇值*******************/
    //状态
    ...
    //继承基类方法
    bill_deliver_header = HczyCommon.extend(bill_deliver_header, ctrl_view_public);
    bill_deliver_header.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
    ...
    $scope.viewColumns = [
        {
            ...
            headerName: "单号", field: "deliver_no", editable: false, filter: 'set', width: 120,
            cellEditor: "文本框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "付款条款名称", field: "payment_type_name", editable: false, filter: 'set', width: 120,
            cellEditor: "文本框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
...
//加载控制器
billmanControllers
    .controller('bill_deliver_header', bill_deliver_header);
