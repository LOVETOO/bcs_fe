...
function edi_lcquotaapplyinfo($scope, $http, $rootScope, $modal, $location, $timeout, BasemanService, $state, localeStorageService, FormValidatorService, HistoryDataService,notify) {
    //继承基类方法
    edi_lcquotaapplyinfo = HczyCommon.extend(edi_lcquotaapplyinfo, ctrl_bill_public);
    edi_lcquotaapplyinfo.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService]);
    //设置当前单据对象基本信息
    ...
    $scope.clearinformation = function () {
        $scope.data = {};
        // $scope.data.currItem.postdata={flag:2};
        $scope.data.currItem = {
    ...
    BasemanService.RequestPostAjax("base_search", "searchdict", {dictcode: "stat"}).then(function (data) {
	 ...
	 BasemanService.RequestPostAjax("base_search", "searchdict", {dictcode: "Edi_commoditygroup_type"}).then(function (data) {
    ...
    BasemanService.RequestPostAjax("base_search", "searchdict", {dictcode: "lastpaymode"}).then(function (data) {
...
//加载控制器
billmanControllers
    .controller('edi_lcquotaapplyinfo', edi_lcquotaapplyinfo)
