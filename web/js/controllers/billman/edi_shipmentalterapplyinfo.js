...
function edi_shipmentalterapplyinfo($rootScope, $scope, $location, $modal, $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {
    //设置当前对象名及主键名    银行代码申请查询
    $scope.objconf = {
        classid: "edi_shipmentalterapplyinfo",
        key: "corpserialid",
        nextStat: "edi_shipmentalterapplyinfoEdit",
        classids: "edi_shipmentalterapplyinfos",
        // postdata: {sqlwhere:"stat=5"},
        sqlBlock: "",
        thead: [],
        grids: [{optionname: 'viewOptions', idname: 'contains'}]
    };
    $scope.headername = "出运申报变更";
    edi_shipmentalterapplyinfo = HczyCommon.extend(edi_shipmentalterapplyinfo, ctrl_view_public);
    edi_shipmentalterapplyinfo.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
    ...
    $scope.viewColumns = [{
        ...
        headerName: "出运申报单", field: "oldcorpserialno", editable: false, filter: 'set', width: 100,
        cellEditor: "文本框",
        enableRowGroup: true,
        enablePivot: true,
        enableValue: true,
        ...
        headerName: "变更原因", field: "alterreason", editable: false, filter: 'set', width: 100,
        cellEditor: "文本框",
        enableRowGroup: true,
        enablePivot: true,
        enableValue: true,
...
//加载控制器
basemanControllers
    .controller('edi_shipmentalterapplyinfo', edi_shipmentalterapplyinfo)
