...
function edi_quotaapplybackinfo($rootScope, $scope, $location, $modal, $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {
    //设置当前对象名及主键名    银行代码申请查询
    $scope.objconf = {
        classid: "edi_quotaapplybackinfo",
        key: "corpserialid",
        nextStat: "edi_quotaapplybackinfoEdit",
        classids: "edi_quotaapplybackinfos",
        // postdata: {sqlwhere:"stat=5"},
        sqlBlock: "",
        thead: [],
        grids: [{optionname: 'viewOptions', idname: 'contains'}]
    };
    $scope.headername = "限额倒签";
    edi_quotaapplybackinfo = HczyCommon.extend(edi_quotaapplybackinfo, ctrl_view_public);
    edi_quotaapplybackinfo.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
    ...
    $scope.viewColumns = [{
        ...
        headerName: "信用证号", field: "lcno", editable: false, filter: 'set', width: 200,
        cellEditor: "文本框",
        enableRowGroup: true,
        enablePivot: true,
        enableValue: true,
        ...
        headerName: "保兑行名称", field: "exbankengname", editable: false, filter: 'set', width: 200,
        cellEditor: "文本框",
        enableRowGroup: true,
        enablePivot: true,
        enableValue: true,
...
//加载控制器
basemanControllers
    .controller('edi_quotaapplybackinfo', edi_quotaapplybackinfo)
