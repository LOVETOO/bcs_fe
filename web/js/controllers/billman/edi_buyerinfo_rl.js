...
function edi_buyerinfo_rl($rootScope, $scope, $location, $modal, $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {
    //设置当前对象名及主键名    银行代码申请查询
    $scope.objconf = {
        classid: "edi_buyerinfo",
        key: "corpserialno2",
        nextStat: "edi_buyerinfo_rlEdit",
        classids: "edi_buyerinfos",
        postdata: {sqlwhere:"cust_code='600000'"},
        // postdata:{sqlBlock: "cust_code='600000'"},
        thead: [],
        grids: [{optionname: 'viewOptions', idname: 'contains'}]
    };
    $scope.headername = "客户认领";
    $scope.hide=true;
    edi_buyerinfo_rl = HczyCommon.extend(edi_buyerinfo_rl, ctrl_view_public);
    edi_buyerinfo_rl.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
...
//加载控制器
basemanControllers
    .controller('edi_buyerinfo_rl', edi_buyerinfo_rl)
