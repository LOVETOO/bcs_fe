...
function bill_invoice_header($rootScope, $scope, $location, $modal, $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {
    //设置当前对象名及主键名
    $scope.objconf = {
        classid: "bill_invoice_header",
        key: "invoice_id",
        nextStat: "bill_invoice_headerEdit",
    ...
    //继承基类方法
    bill_invoice_header = HczyCommon.extend(bill_invoice_header, ctrl_view_public);
    bill_invoice_header.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
...
//加载控制器
basemanControllers
    .controller('bill_invoice_header', bill_invoice_header);
