...
function edi_plnotice_sett($rootScope, $scope, $location, $modal, $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {
    //设置当前对象名及主键名    银行代码申请查询
    $scope.objconf = {
        classid: "edi_plnotice_sett",
        key: "corpserialid",
        nextStat: "edi_plnotice_settEdit",
        classids: "edi_plnotice_setts",
        // postdata: {sqlwhere:"stat=5"},
        sqlBlock: "",
        thead: [],
        grids: [{optionname: 'viewOptions', idname: 'contains'}]
    };
    $scope.headername = "可损结案";
    edi_plnotice_sett = HczyCommon.extend(edi_plnotice_sett, ctrl_view_public);
    edi_plnotice_sett.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
    ...
    $scope.viewColumns = [{
        ...
        headerName: "客户买家编号", field: "corpbuyerno", editable: false, filter: 'set', width: 100,
        cellEditor: "文本框",
        enableRowGroup: true,
        enablePivot: true,
        enableValue: true,
        ...
        headerName: "报损原因", field: "plreasoncode", editable: false, filter: 'set', width: 200,
        cellEditor: "文本框",
        enableRowGroup: true,
        enablePivot: true,
        enableValue: true,
        ...
        headerName: "最终索赔金额", field: "sett_amt", editable: false, filter: 'set', width: 100,
        cellEditor: "文本框",
        enableRowGroup: true,
        enablePivot: true,
        enableValue: true,
        ...
        headerName: "撤销处理类型", field: "sett_type", editable: false, filter: 'set', width: 100,
        cellEditor: "下拉框",
        cellEditorParams: {
            values: [{value: 1, desc: '撤案'}, {value: 2, desc: '结案'}]
        },
        enableRowGroup: true,
        enablePivot: true,
        enableValue: true,
...
//加载控制器
basemanControllers
    .controller('edi_plnotice_sett', edi_plnotice_sett)
