...
function bill_invoice_split_header($rootScope, $scope, $location, $modal,$timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {
    //设置当前对象名及主键名
    $scope.objconf = {
        classid: "bill_invoice_split_header",
        key: "invoice_id",
        nextStat: "bill_invoice_split_headerEdit",
        classids: "bill_invoice_split_headers",
        postdata: {
        },
        thead:[],
        grids:[{optionname:'viewOptions', idname:'contains'}]
    };
    $scope.headername="商业发票拆分/合并";
    /*********************系统词汇值*******************/
    //状态
    ...
    //继承基类方法
    bill_invoice_split_header = HczyCommon.extend(bill_invoice_split_header, ctrl_view_public);
    bill_invoice_split_header.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
...
//加载控制器
basemanControllers
    .controller('bill_invoice_split_header', bill_invoice_split_header);
