...
function edi_nolcquotaapplyinfoUpdate($rootScope, $scope, $location, $modal, $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {
    //设置当前对象名及主键名    银行代码申请查询
    $scope.objconf = {
        classid: "edi_nolcquotaapplyinfo",
        key: "corpserialid",
        nextStat: "edi_nolcquotaapplyinfo",
    ...
    $scope.headername = "非限额修改申请";
    $scope.hide=true;
    edi_nolcquotaapplyinfoUpdate = HczyCommon.extend(edi_nolcquotaapplyinfoUpdate, ctrl_view_public);
    edi_nolcquotaapplyinfoUpdate.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
    ...
    $scope.viewColumns = [{
        ...
        headerName: "历史限额申请单号", field: "source_code", editable: false, filter: 'set', width: 100,
        cellEditor: "文本框",
        enableRowGroup: true,
        enablePivot: true,
        enableValue: true,
...
//加载控制器
basemanControllers
    .controller('edi_nolcquotaapplyinfoUpdate', edi_nolcquotaapplyinfoUpdate)
