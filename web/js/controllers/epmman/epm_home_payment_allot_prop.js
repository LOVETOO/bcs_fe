                ...
                $scope.chooseData = function () {
                    $modal.openCommonSearch({
                        ...
                        .then(function (result) {
                            ...
                            ['payment_import_id',   //到款记录单
                            'payment_import_code',  //到款记录编号
                            'serial_number',        //银行流水号
                            'receive_bank',         //收款银行
                            'receive_account',      //收款账号
                            'receive_unit_name',    //收款公司
                            'receive_date',         //收款日期
                            'remit_unit_code',      //汇款单位编码
                            'remit_unit_old_code',  //汇款单位名称
                            'remit_unit_name',      //汇款单位名称
                            'receive_amt',          //收款金额
                            'currency_name',        //币别名称
                            'exchange_rate',        //汇率
                            'payment_remark',       //打款说明
                            ...
                            'customer_name'         //客户名称
                                ...
                                $scope.data.currItem[field]=result[field]
                            });
