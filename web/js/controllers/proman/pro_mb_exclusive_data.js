...
function pro_mb_exclusive_data($rootScope, $scope, $location, $modal, $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {
    //设置当前对象名及主键名
    $scope.objconf = {
        classid: "pro_mb_exclusive_data",
        key: "pro_id",
        nextStat: "pro_mb_exclusive_dataEdit",
        classids: "pro_mb_exclusive_datas",
        sqlBlock: "1=1",
        thead: [],
        grids: [{optionname: 'viewOptions', idname: 'contains'}]
    };
    $scope.headername = "全球独家面板";
    // $scope.hide = true;
    pro_mb_exclusive_data = HczyCommon.extend(pro_mb_exclusive_data, ctrl_view_public);
    pro_mb_exclusive_data.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
...
//加载控制器
basemanControllers
    .controller('pro_mb_exclusive_data', pro_mb_exclusive_data)
