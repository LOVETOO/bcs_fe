...
/**这是信息查询界面js*/
function fin_fee_type($scope, $location, $rootScope, $modal, $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {

//设置标题
    $scope.headername = "费用类别";
...
angular.module("inspinia")
    .controller("fin_fee_type", fin_fee_type);
