...
function fin_ship_invoice_search($scope, $location, $rootScope, $modal, notify, $timeout, BasemanService, $state, localeStorageService, FormValidatorService) {
    //继承基类方法
    fin_ship_invoice_search = HczyCommon.extend(fin_ship_invoice_search, ctrl_bill_public);
    fin_ship_invoice_search.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService]);
    //设置当前单据对象基本信息
    $scope.objconf = {
...
$scope.search = function () {
	...
	var postdata = { flag:15,
		 ...
		 sale_sap: $scope.data.currItem.delorder_sap,
		  sap_no: $scope.data.currItem.kaipiao_sap
...
$scope.columns_13 = [
        {
            ...
            headerName: "SAP销售订单号", field: "sap_sale", editable: false, filter: 'set', width: 150,
            cellEditor: "文本框",
            ...
            headerName: "SAP发货单正常发票凭证号", field: "kaipiao_sap", editable: false, filter: 'set', width: 150,
            cellEditor: "文本框",
            ...
            headerName: "SAP发货单正常开票发票号", field: "fapiao_sap", editable: false, filter: 'set', width: 150,
            cellEditor: "文本框",
            ...
            headerName: "SAP销售凭证生成时间", field: "check_time", editable: false, filter: 'set', width: 150,
            cellEditor: "文本框",
            ...
            headerName: "SAP开票时间", field: "erp_time", editable: false, filter: 'set', width: 150,
            cellEditor: "文本框",
            ...
            headerName: "开票金额", field: "amt", editable: false, filter: 'set', width: 150,
            cellEditor: "文本框",
...
//加载控制器
basemanControllers
    .controller('fin_ship_invoice_search', fin_ship_invoice_search);
