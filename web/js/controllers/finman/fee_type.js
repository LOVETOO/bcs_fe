               ...
               /* $modal.open({
                ...
                $scope.delete = function () {
                    ...
                    return swalApi.confirmThenSuccess({
                        title: "确定要删除类别吗?",
                        okFun: function () {
                            requestApi.post("fin_fee_type", "delete", {
                ...
                $scope.UpdateSortModal = function () {
                    ...
                    return swalApi.confirmThenSuccess({
                        title: "确定要修改类别吗?",
                        okFun: function () {
                            requestApi.post("fin_fee_type", "update", {
                ...
                $scope.AddSortModal = function () {
                    ...
                    return swalApi.confirmThenSuccess({
                        ...
                        okFun: function () {
                            ...
                            requestApi.post("fin_fee_type", "insert", data).then(
                                function (data) {
                ...
                $scope.saveDetail = function () {
                    ...
                    // console.log("aar",arr)
                    requestApi.post("fin_fee_type", "update_fee_info", {
                        fee_type_id: $scope.treeSetting.zTreeObj.getSelectedNodes()[0].data.fee_type_id,
                        idpath: $scope.treeSetting.zTreeObj.getSelectedNodes()[0].data.idpath,
