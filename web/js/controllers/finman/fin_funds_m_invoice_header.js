...
function fin_funds_m_invoice_header($rootScope, $scope, $location, $modal,$timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {
    //设置当前对象名及主键名
    $scope.objconf = {
        classid: "fin_funds_m_invoice_header",
        key: "allo_m_id",
        nextStat: "fin_funds_m_invoice_headerEdit",
        classids: "fin_funds_m_invoice_headers",
        sqlBlock: "1=1",
        thead:[],
        grids:[{optionname:'viewOptions', idname:'contains'}]
    };
    $scope.headername="商业发票手工行更改";
    //继承基类方法
    fin_funds_m_invoice_header = HczyCommon.extend(fin_funds_m_invoice_header, ctrl_view_public);
    fin_funds_m_invoice_header.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
    ...
    $scope.viewColumns = [
        {
            ...
            headerName: "分配单号", field: "allo_m_no", editable: false, filter: 'set', width: 120,
            cellEditor: "文本框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
...
//加载控制器
basemanControllers
    .controller('fin_funds_m_invoice_header', fin_funds_m_invoice_header);
