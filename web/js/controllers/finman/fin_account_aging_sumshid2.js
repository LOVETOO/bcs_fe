...
function fin_account_aging_sumshid2($scope, $location, $rootScope, $modal, notify, $timeout, BasemanService, $state, localeStorageService, FormValidatorService) {
    //继承基类方法
    fin_account_aging_sumshid2 = HczyCommon.extend(fin_account_aging_sumshid2, ctrl_bill_public);
    fin_account_aging_sumshid2.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService]);
    //设置当前单据对象基本信息
    $scope.objconf = {
   ...
   /*     key: "funds_id",*/
        ...
        grids: [{optionname: 'options_11', idname: 'bill_invoice_lineofbill_invoice_headers'}, {
            ...
            idname: 'bill_invoice_lineofbill_invoice_headers'
   ...
   $scope.search = function () {
	   if($scope.data.currItem.end_date=="" || $scope.data.currItem.end_date==undefined){
		   BasemanService.notice("请输入截止日期", "alert-warning");
            return;
	   }
	sqlBlock="";
...
/*            cellEditorParams: {
        ...
        {
            headerName: "已汇款金额", field: "amt_gathering", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "信用天数", field: "xy_days", editable: false, filter: 'set', width: 100,
            cellEditor: "整数框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
            ...
            headerName: "考核日", field: "check_date", editable: false, filter: 'set', width: 100,
            cellEditor: "年月日",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
            ...
            headerName: "0-15天", field: "amount1", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
            ...
            headerName: "15-30天", field: "amount2", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
            ...
            headerName: "30-60天", field: "amount3", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
            ...
            headerName: "60-90天", field: "amount4", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
            ...
            headerName: "90天以上", field: "amount6", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
...
//加载控制器
finmanControllers
    .controller('fin_account_aging_sumshid2', fin_account_aging_sumshid2);
