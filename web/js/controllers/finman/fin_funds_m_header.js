...
function fin_funds_m_header($rootScope, $scope, $location, $modal,$timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {
    ...
    $scope.beforClearInfo = function () {
        ...
        if(name=="crmman.fin_funds_m_header_tt"){
            $scope.objconf.postdata={ sqlwhere:"funds_type=1"};//到款变更
            $scope.objconf.nextStat="fin_funds_m_header_ttEdit";
            $scope.headername="TT到款变更";
        }else if(name=="crmman.fin_funds_m_header_ttrl"){
            $scope.objconf.postdata={ sqlwhere:"funds_type=1 and change_type=2 "};  //认领错
            $scope.objconf.nextStat="fin_funds_m_header_ttrlEdit";
            $scope.headername="客户认领变更";
        }else if(name=="crmman.fin_funds_m_header_kf"){
            $scope.objconf.postdata={ sqlwhere:"funds_type=1 and change_type=4"}; //扣费变更
            $scope.objconf.nextStat="fin_funds_m_header_kfEdit";
            $scope.headername="扣费变更";
        }else if(name=="crmman.fin_funds_m_header_zjxt"){
            $scope.objconf.postdata={ sqlwhere:"funds_type=1 and change_type=3"};//系统单号变更
            $scope.objconf.nextStat="fin_funds_m_header_zjxtEdit";
            $scope.headername="变更资金系统单号";
        }else if(name=="crmman.fin_funds_m_header_lc"){
            $scope.objconf.postdata={ sqlwhere:"funds_type=2 "};//系统单号变更
            $scope.objconf.nextStat="fin_funds_m_header_lcEdit";
            $scope.headername="信用证到款录入变更";
        }
    };
    ...
    //ERP回款组织
    BasemanService.RequestPostAjax("base_search", "searchdict", {dictcode: "yn_return_type"})
        .then(function (data) {
            var yn_return_types = [];
            for (var i = 0; i < data.dicts.length; i++) {
                yn_return_types[i] = {
            ...
            if ($scope.getIndexByField('viewColumns', 'yn_return_type')) {
                $scope.viewColumns[$scope.getIndexByField('viewColumns', 'yn_return_type')].cellEditorParams.values = yn_return_types;
            }
        });
    //回款组织
    ...
    $scope.viewColumns = [
        ...
        {
            headerName: "汇款人", field: "hk_man", editable: false, filter: 'set', width: 85,
            cellEditor: "文本框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "付款总额", field: "fact_amt", editable: false, filter: 'set', width: 85,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "扣费", field: "amt_deduct", editable: false, filter: 'set', width: 85,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "利息", field: "lc_interest", editable: false, filter: 'set', width: 85,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "业务部门", field: "org_code", editable: false, filter: 'set', width: 85,
            cellEditor: "文本框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "确认人", field: "confirm_man", editable: false, filter: 'set', width: 85,
            cellEditor: "文本框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "当前汇率", field: "exchange_rate", editable: false, filter: 'set', width: 85,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "原利息", field: "cur_lc_interest", editable: false, filter: 'set', width: 85,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
