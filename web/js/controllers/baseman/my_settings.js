function my_settings($scope, $location, $state, $http, $rootScope, $modal, BasemanService, localeStorageService, $timeout) {
    ...
    var choose_wf = function ($scope, notify, $modal, $state, $timeout, $location, BasemanService, localeStorageService, $rootScope, $modalInstance) {
            ...
            function beforeExpand(treeId, treeNode) {
                ...
                BasemanService.RequestPost("cpcfdr", "selectref", param)
                    .then(function (data) {
                        //添加节点
                        zTreeNodes = [];
            ...
            $scope.init_Tree = function () {
                ...
                BasemanService.RequestPost("cpcworkspace", "selectref", wsobj).then(function (data) {
                    ...
                    BasemanService.RequestPost("cpcfdr", "selectref", param).then(function (data) {
    ...
    //出差
    var cpcuseragen = function ($scope, notify, $modal, $state, $timeout, $location, BasemanService, localeStorageService, $rootScope, $modalInstance, FormValidatorService) {
        cpcuseragen = HczyCommon.extend(cpcuseragen, ctrl_bill_public);
        cpcuseragen.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService]);
        ...
        $scope.refresh = function (flag) {
            ...
            //页面加载时,要将出差消息显示出来
            BasemanService.RequestPost("cpcuser", "getagent", {
        ...
        $scope.ok_save = function (e) {
            ...
            //发包保存
            BasemanService.RequestPost("cpcuser", "changeagent", {
                userid: $scope.userid,
                goout: $scope.goout,
    ...
    $scope.saveUserImfo = function () {
        BasemanService.RequestPost("cpcuser", "update", {"userid": strUserId}).then(function (result) {
    ...
    $scope.searchData = function () {
        BasemanService.RequestPost("cpcuser", "select", {"userid": strUserId}).then(function (result) {
            $scope.data.currItem = result;
        }).then(function () {
...
// .controller('cpcuseragen', cpcuseragen)
// .controller('cpcuseralert', cpcuseralert)
