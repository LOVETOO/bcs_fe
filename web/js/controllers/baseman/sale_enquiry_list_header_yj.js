...
function sale_enquiry_list_header_yj($scope, notify, $modal, $state, $timeout, $location, BasemanService, localeStorageService, $rootScope) {
    sale_enquiry_list_header_yj = HczyCommon.extend(sale_enquiry_list_header_yj, ctrl_view_public);
    sale_enquiry_list_header_yj.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
    ...
    $scope.objconf = {
        ...
        key: "enquirylist_id",
        nextStat: "sale_enquiry_list_headerEdit_yj",
        classids: "sale_enquiry_list_headers",
        postdata: {sqlwhere:"bill_type=2"},
...
// 产品资料
promanControllers
    .controller('sale_enquiry_list_header_yj', sale_enquiry_list_header_yj)
