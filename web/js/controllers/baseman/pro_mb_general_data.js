...
function pro_mb_general_data($rootScope, $scope, $location, $modal, $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService) {
    //设置当前对象名及主键名
    $scope.objconf = {
        classid: "pro_mb_general_data",
        key: "pro_id",
        nextStat: "pro_mb_general_dataEdit",
        classids: "pro_mb_general_datas",
        sqlBlock: "1=1",
        thead: [],
        grids: [{optionname: 'viewOptions', idname: 'contains'}]
    };
    $scope.headername = "普通面板";
    $scope.hide = true;
    pro_mb_general_data = HczyCommon.extend(pro_mb_general_data, ctrl_view_public);
    pro_mb_general_data.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
    ...
    $scope.viewColumns = [{
        ...
        headerName: "装饰条颜色", field: "mb_article", editable: false, filter: 'set', width: 150,
        cellEditor: "文本框",
        ...
        headerName: "国家", field: "area_name", editable: false, filter: 'set', width: 150,
        cellEditor: "文本框",
...
//加载控制器
basemanControllers
    .controller('pro_mb_general_data', pro_mb_general_data)
