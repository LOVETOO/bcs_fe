 ...
 * @since 2018-04-27
 */
angular.module('inspinia').controller('crm_project_header', function ($scope, BasemanService, BillService) {
    ...
    BasemanService
        ...
        .then(function () {
            BillService.decorateHead($scope, {
                ...
                detailUrl: '/index.jsp#/saleman/crm_project_bill/',
                headerColumns: [{
                    field: 'stat',
                    name: '状态',
                    dictcode: '.',
    ...
    $scope.btnAddClick = function () {
        BasemanService.openModal({
            url: "/index.jsp#/saleman/crm_project_bill/0",
    ...
    $scope.viewDetail = function (args) {
        BasemanService.openModal({
            url: "/index.jsp#/saleman/crm_project_bill/" + args.grid.getDataItem(args.row).project_id,
            title: $scope.getTitle(),
            obj: $scope,
            ondestroy: $scope.btnRefreshClick
        });
