...
function sale_forecast_search_lt($scope, $location, $rootScope, $modal, notify, $timeout, BasemanService, $state, localeStorageService, FormValidatorService) {
    //继承基类方法
    sale_forecast_search_lt = HczyCommon.extend(sale_forecast_search_lt, ctrl_bill_public);
    sale_forecast_search_lt.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService]);
    //设置当前单据对象基本信息
    $scope.objconf = {
 ...
 BasemanService.RequestPost("fin_amount_search", "search", postdata)
   ...
   $scope.selectcust = function () {
    ...
    $scope.columns_11 = [
        {
            ...
            headerName: "发货金额", field: "amt", editable: false, filter: 'set', width: 150,
            cellEditor: "文本框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "应收款金额", field: "reduce_amt", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
    ...
    $scope.columns_12 = [
        ...
        , {
            headerName: "发货通知单", field: "notice_no", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
            ...
            headerName: "付款条款", field: "dname", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
...
/*            cellEditorParams: {
        ...
        , {
            headerName: "币种", field: "currency_code", editable: true, filter: 'set', width: 120,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        , {
            headerName: "实现金额", field: "amt1", editable: false, filter: 'set', width: 100,
            cellEditor: "勾选框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
...
//加载控制器
finmanControllers
    .controller('sale_forecast_search_lt', sale_forecast_search_lt);
