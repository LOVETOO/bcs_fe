...
function sale_guide_price_search($scope, $location, $rootScope, $modal, notify, $timeout, BasemanService, $state, localeStorageService, FormValidatorService) {
    //继承基类方法
    sale_guide_price_search = HczyCommon.extend(sale_guide_price_search, ctrl_bill_public);
    sale_guide_price_search.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService]);
    //设置当前单据对象基本信息
    $scope.objconf = {
        name: "sale_guide_priceapply_header",
        FrmInfo: {},
        grids: [{optionname: 'options_13', idname: 'sale_guide_priceapply_line2ofsale_guide_priceapply_headers'}]
    };
    //查询
    $scope.search = function () {
        ...
        BasemanService.RequestPost("sale_guide_priceapply_header", "getitemlist", postdata)
            .then(function (data) {
                ...
                $scope.options_13.api.setRowData(data.sale_guide_priceapply_line2ofsale_guide_priceapply_headers);
            });
    };
    /***************************弹出框***********************/
    //整机编码
    ...
    $scope.columns_13 = [
        {
            ...
            headerName: "指定标准成本", field: "std_price", editable: false, filter: 'set', width: 150,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
            ...
            headerName: "指导价（美元）", field: "base_price", editable: false, filter: 'set', width: 150,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
            ...
            headerName: "指导价（人民币）", field: "settle_price", editable: false, filter: 'set', width: 150,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
...
//加载控制器
basemanControllers
    .controller('sale_guide_price_search', sale_guide_price_search);
