...
function sale_ship_packagelineseach($scope, $location, $rootScope, $modal, notify, $timeout, BasemanService, $state, localeStorageService, FormValidatorService) {
    //继承基类方法
    sale_ship_packagelineseach = HczyCommon.extend(sale_ship_packagelineseach, ctrl_bill_public);
    sale_ship_packagelineseach.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService]);
    //设置当前单据对象基本信息
    $scope.objconf = {
...
$scope.search = function () {
	...
	var sqlBlock="";
	if(date1>date2 && date1!="" && date1!=undefined){
...
//加载控制器
basemanControllers
    .controller('sale_ship_packagelineseach', sale_ship_packagelineseach);
