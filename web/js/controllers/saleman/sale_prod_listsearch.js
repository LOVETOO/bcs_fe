...
function sale_prod_listsearch($scope, $location, $rootScope, $modal, notify, $timeout, BasemanService, $state, localeStorageService, FormValidatorService) {
    //继承基类方法
    sale_prod_listsearch = HczyCommon.extend(sale_prod_listsearch, ctrl_bill_public);
    sale_prod_listsearch.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService]);
    //设置当前单据对象基本信息
    $scope.objconf = {
...
$scope.columns_13 = [
        {
            ...
            headerName: "商检批号", field: "inspection_batchno", editable: true, filter: 'set', width: 150,
            cellEditor: "文本框",
            //cellchange:$scope.bankBalance,
            enableRowGroup: true,
            enablePivot: true,
            ...
            floatCell: true
                ...
                headerName: "发货通知单号", field: "notice_no", editable: true, filter: 'set', width: 100,
                cellEditor: "文本框",
            ...
            headerName: "大区", field: "area_name", editable: true, filter: 'set', width: 150,
            cellEditor: "文本框",
            ...
            headerName: "发货总数量(台)", field: "totalqty", editable: true, filter: 'set', width: 150,
            cellEditor: "文本框",
            ...
            headerName: "佣金金额(USD)", field: "yongjin", editable: true, filter: 'set', width: 150,
            cellEditor: "文本框",
            ...
            headerName: "佣金比例(%)", field: "amt2", editable: true, filter: 'set', width: 150,
            cellEditor: "文本框",
            ...
            headerName: "佣金支配金额(USD)", field: "amt1", editable: true, filter: 'set', width: 150,
            cellEditor: "文本框",
...
//加载控制器
basemanControllers
    .controller('sale_prod_listsearch', sale_prod_listsearch);
