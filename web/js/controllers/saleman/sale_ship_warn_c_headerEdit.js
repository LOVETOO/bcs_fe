...
function sale_ship_warn_c_headerEdit($scope, $location, $http, $rootScope, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService, HistoryDataService) {

    //继承基类方法
    sale_ship_warn_c_headerEdit = HczyCommon.extend(sale_ship_warn_c_headerEdit, ctrl_bill_public);
    sale_ship_warn_c_headerEdit.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService]);
    //设置当前单据对象基本信息
    $scope.objconf = {
        name: "sale_ship_warn_c_header",
        key: "warn_c_id",
        wftempid: 10083,
        FrmInfo: {},
        grids: [
            {//信用证
                optionname: 'lcoptions',
                idname: 'sale_ship_warn_c_lc_lineofsale_ship_warn_c_headers'
            }, {//询价记录
                optionname: 'enquiryoptions',
                idname: 'sale_ship_warn_c_enquiryofsale_ship_warn_c_headers'
            }, {//运保费
                optionname: 'shipitemoptions',
                idname: 'sale_ship_warn_c_itemofsale_ship_warn_c_headers'
            }, {//免费配件金额
                optionname: 'partamtoptions',
                idname: 'sale_ship_warn_c_part_amt_lineofsale_ship_warn_c_headers'
            }, {//产品明细
                optionname: 'itemoptions',
                idname: 'sale_ship_warn_c_line_sumofsale_ship_warn_c_headers'
            }, {//单列配件信息
                optionname: 'linepartoptions',
                idname: 'sale_ship_warn_c_part_lineofsale_ship_warn_c_headers'
            }, {//柜型
                optionname: 'boxlineoptions',
                idname: 'sale_ship_warn_c_box_lineofsale_ship_warn_c_headers',
                line: {//柜中明细
                    optionname: 'prearroptions',
                    idname: 'sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines'
                }
            }, {//待排箱货物
                optionname: 'waitarroptions',
                idname: 'waitdatas'
            }, {//排柜明细汇总
                optionname: 'sumoptions',
                idname: 'sale_ship_warn_c_lineofsale_ship_warn_c_headers'
            }, {
                optionname: 'packageoptions',
                idname: 'sale_ship_warn_c_package_lineofsale_ship_warn_c_headers'
            }
        ]
    };
    ...
    $scope.warn_no = function () {
        $scope.FrmInfo = {
            ...
            sqlBlock: ' stat =5 and not exists (select 1 from sale_ship_notice_header n where n.warn_id=sale_ship_warn_header.warn_id and n.stat <> 99 ) '
            + ' and not exists (select 1 from sale_ship_warn_c_header m where m.warn_id=sale_ship_warn_header.warn_id and m.stat <> 5)',
        };
        BasemanService.open(CommonPopController, $scope)
            ...
            BasemanService.RequestPost("sale_ship_warn_header", "select", {warn_id: data.warn_id}).then(function (data) {
                ...
                $scope.data.currItem.sale_ship_warn_c_line_sumofsale_ship_warn_c_headers = data.sale_ship_warn_line_sumofsale_ship_warn_headers;
                $scope.data.currItem.sale_ship_warn_c_h_lineofsale_ship_warn_c_headers = data.sale_ship_warn_h_lineofsale_ship_warn_headers;
                $scope.data.currItem.sale_ship_warn_c_lc_lineofsale_ship_warn_c_headers = data.sale_ship_warn_lc_lineofsale_ship_warn_headers;
                $scope.data.currItem.sale_ship_warn_c_enquiryofsale_ship_warn_c_headers = data.sale_ship_warn_enquiryofsale_ship_warn_headers;
                $scope.data.currItem.sale_ship_warn_c_lineofsale_ship_warn_c_headers = data.sale_ship_warn_lineofsale_ship_warn_headers;
                $scope.data.currItem.sale_ship_warn_c_line2ofsale_ship_warn_c_headers = data.sale_ship_warn_line2ofsale_ship_warn_headers;
                $scope.data.currItem.sale_ship_warn_c_box_lineofsale_ship_warn_c_headers = data.sale_ship_warn_box_lineofsale_ship_warn_headers;
                var obj;
                for (var i = 0; i < data.sale_ship_warn_box_lineofsale_ship_warn_headers.length; i++) {
                    obj = data.sale_ship_warn_box_lineofsale_ship_warn_headers[i];
                    obj.sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines = obj.sale_ship_warn_line_sumofsale_ship_warn_box_lines;
                    delete obj.sale_ship_warn_line_sumofsale_ship_warn_box_lines;
                }
                $scope.data.currItem.sale_ship_warn_c_part_lineofsale_ship_warn_c_headers = data.sale_ship_warn_part_lineofsale_ship_warn_headers;
                $scope.data.currItem.sale_ship_warn_c_package_lineofsale_ship_warn_c_headers = data.sale_ship_warn_package_lineofsale_ship_warn_headers;
                $scope.data.currItem.sale_ship_warn_c_itemofsale_ship_warn_c_headers = data.sale_ship_warn_itemofsale_ship_warn_headers;
                $scope.data.currItem.sale_ship_warn_c_part_amt_lineofsale_ship_warn_c_headers = data.sale_ship_warn_part_amt_lineofsale_ship_warn_headers;
    ...
    $scope.is_change = function () {
        $timeout(function () {
            if ($scope.data.currItem.is_change == "1") {
                $scope.boxlineoptions.columnApi.setColumnVisible("operate", false);
                if ($scope.data.currItem.stat == 1) {
                    $scope.setgridstat(5);
                }
            } else if ($scope.data.currItem.is_change == "2") {
                $scope.boxlineoptions.columnApi.setColumnVisible("operate", false);
                if ($scope.data.currItem.stat == 1) {
                    $scope.setgridstat(1);
                }
            } else if ($scope.data.currItem.is_change == "3") {
                $scope.boxlineoptions.columnApi.setColumnVisible("operate", false);
                if ($scope.data.currItem.stat == 1) {
                    $scope.setgridstat(5);
                }
            } else if ($scope.data.currItem.is_change == "4") {
                $scope.boxlineoptions.columnApi.setColumnVisible("operate", true);
                if ($scope.data.currItem.stat == 1) {
                    $scope.setgridstat(5);
                    $scope.boxlinecolumns[$scope.getIndexByField("boxlinecolumns", "operate")].editable = true;
                }
            } else if ($scope.data.currItem.is_change == "5") {
                $scope.boxlineoptions.columnApi.setColumnVisible("operate", false);
                if ($scope.data.currItem.stat == 1) {
                    $scope.setgridstat(5);
                    $scope.itemcolumns[$scope.getIndexByField("itemcolumns", "printqty")].editable = true;
                    $scope.itemcolumns[$scope.getIndexByField("itemcolumns", "printxqty")].editable = true;
                    $scope.itemcolumns[$scope.getIndexByField("itemcolumns", "p_total_gw")].editable = true;
                    $scope.itemcolumns[$scope.getIndexByField("itemcolumns", "p_total_nw")].editable = true;
                    $scope.itemcolumns[$scope.getIndexByField("itemcolumns", "p_total_tj")].editable = true;

                    $scope.prearrcolumns[$scope.getIndexByField("prearrcolumns", "printqty")].editable = true;
                    $scope.prearrcolumns[$scope.getIndexByField("prearrcolumns", "printxqty")].editable = true;
                    $scope.prearrcolumns[$scope.getIndexByField("prearrcolumns", "p_total_gw")].editable = true;
                    $scope.prearrcolumns[$scope.getIndexByField("prearrcolumns", "p_total_nw")].editable = true;
                    $scope.prearrcolumns[$scope.getIndexByField("prearrcolumns", "p_total_tj")].editable = true;
                }
            }
            $scope.boxlineoptions.api.refreshView();
        },1)
    }
    ...
    /**网格配置*/
    {
        ...
        //lcoptions
        {
            ...
            $scope.selectlc = function (itemlines, is_to_other, is_to_itemoptions, ischeckbox) {
                var pi_id = "-1";
                ...
                BasemanService.open(CommonPopController, $scope, "", "lg").result.then(function (items) {
                    ...
                    var lcs = $scope.gridGetData("lcoptions");
                    var isExists = false;
                    for (var i = 0; i < items.length; i++) {
                        /*处理产品明细的LC_bill_no*/
                        if (is_to_other) {//如果要影响其它列
                            itemlines = $scope.gridGetData('itemoptions');
                        }
                        ...
                        $scope.gridAddItem('lcoptions', items[i]);
                    }
                    if (is_to_other) {//如果要影响其它列
                        itemlines = $scope.gridGetData('itemoptions');
                    } else if (is_to_other == false) {
                        itemlines = $scope.gridUpdateRow('itemoptions', itemlines[0]);
                    }
                })
            }
            $scope.delcntitem = function () {
                var lc = $scope.gridGetRow("lcoptions");
                var itemlines = $scope.gridGetData("itemoptions");
                for (var i = 0; i < itemlines.length; i++) {
                    if (itemlines[i].pi_id == lc.pi_id) {
                        itemlines[i].lc_bill_no = undefined;
                    }
                }
                $scope.gridDelItem('lcoptions')
            }
            ...
            $scope.lcoptions = {
                ...
                checkboxSelection: function (params) {
                    var isGrouping = $scope.lcoptions.columnApi.getRowGroupColumns().length > 0;
        ...
        //enquiryoptions
        {
            ...
            $scope.addenquiryitem = function () {
                var data = $scope.gridGetData("boxlineoptions");
                if (data.length < 1) {
        ...
        //shipitemoptions
        {
            $scope.itemRowClicked=function () {
                if($scope.data.currItem.stat!=1){
                    return;
                }
                if($scope.data.currItem.pay_style!=1&&$scope.data.currItem.price_type_id!=81){
                    var data=$scope.gridGetData("itemoptions");
                    if(data.length>0){
                        $scope.gridSetData("itemoptions",[]);
                        $scope.itemcolumns[$scope.getIndexByField("itemcolumns","amt_fee")].editable=false;
                        $scope.itemcolumns[$scope.getIndexByField("itemcolumns","print_amt")].editable=false;
                    }
                    return;
                }
                $scope.itemcolumns[$scope.getIndexByField("itemcolumns","amt_fee")].editable=true;
                $scope.itemcolumns[$scope.getIndexByField("itemcolumns","print_amt")].editable=true;

            }

            $scope.shipitemoptions = {
                rowGroupPanelShow: 'onlyWhenGrouping', // on of ['always','onlyWhenGrouping']
                pivotPanelShow: 'always', // on of ['always','onlyWhenPivoting']
                groupKeys: undefined,
                groupHideGroupColumns: false,
                ...
                rowDeselection: false,
                quickFilterText: null,
                rowClicked: $scope.itemRowClicked,
                groupSelectsChildren: false, // one of [true, false]
                suppressRowClickSelection: true, // if true, clicking rows doesn't select (useful for checkbox selection)
                groupColumnDef: groupColumn,
                showToolPanel: false,
                checkboxSelection: function (params) {
                    var isGrouping = $scope.shipitemoptions.columnApi.getRowGroupColumns().length > 0;
                    return params.colIndex === 0 && !isGrouping;
                },
                icons: {
                    columnRemoveFromGroup: '<i class="fa fa-remove"/>',
            ...
            $scope.shipitemcolumns = [
                {
                    ...
                    headerName: "保费", field: "print_amt", editable: false, filter: 'set', width: 100,
                    cellEditor: "浮点框",
                    enableRowGroup: true,
                    enablePivot: true,
                    enableValue: true,
        ...
        //itemoptions,根据是否是空白行，判断列的可编辑
        {
                ...
                BasemanService.open(CommonPopController, $scope, "", "lg")
                    ...
                    if (items.length > 0) {
                        ...
                        for (var i = 0; i < items.length; i++) {
                            ...
                            items[i].pack_type = "CTNS";
                            items[i].ab_votes = "A";
                            items[i].add_row = "1";
                            if (parseInt(items[i].sj_type) == 7) {//7表示全散
                        ...
                        $scope.gridSetData('itemoptions', data);
            ...
            $scope.split = function () {
                var select_row = $scope.selectGridGetData('itemoptions');
                ...
                BasemanService.openFrm("views/Pop_copy_Line.html", PopCopyLineController, $scope)
                    ...
                    $scope.selectGridDelItem('itemoptions');//删除勾选行的数据
                    for (var i = 0; i < result.lines; i++) {
                        ...
                        $scope.gridAddItem('itemoptions', spiltRow[i])
                    }
                });
            ...
            $scope.addblankline = function () {
                ...
                $scope.gridAddItem('itemoptions', itemTemp)
            }
            ...
            $scope.copyline = function () {
                ...
                $scope.gridAddItem('itemoptions', inputobj);
            }


            $scope.calgwnw = function () {
                var items = $scope.gridGetData('itemoptions');
                var sums = $scope.gridGetData('sumoptions')
                var sumid;
                for (var i = 0; i < items.length; i++) {
                ...
                var boxlines = $scope.gridGetData('boxlineoptions');
                ...
                $scope.gridSetData('itemoptions', items)
                $scope.gridSetData('sumoptions', sums)
                $scope.gridSetData('boxlineoptions', boxlines)
            }
            $scope.getgw = function () {
                BasemanService.RequestPost("sale_ship_warn_c_header", "getitemgw", {varn_id: $scope.data.currItem.warn_id}).then(function (data) {
                    if (data.sale_ship_warn_c_lineofsale_ship_warn_c_headers.length < 1) {
                        BasemanService.notice("没有称重数据!")
                        return;
                    }
                    var objline = {}, qty
                    var items = $scope.gridGetData('itemoptions');
                    for (var i = 0; i < data.sale_ship_warn_c_lineofsale_ship_warn_c_headers.length; i++) {
                        objline = data.sale_ship_warn_c_lineofsale_ship_warn_c_headers[i];
            ...
            $scope.delaoline = function () {
                var dellines = $scope.selectGridGetData("itemoptions");
                var boxs = $scope.gridGetData("boxlineoptions");
                var sums = $scope.gridGetData("sumoptions");
                var waitdatas = $scope.gridGetData("waitarroptions");
                var lines = [];
                var obj = {}
                for (var i = 0; i < boxs.length; i++) {
                    lines = boxs[i].sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines;
                ...
                $scope.selectGridDelItem("itemoptions");
                $scope.gridSetData("sumoptions", sums);
            }
            ...
            $scope.itemoptions = {
                ...
                rowClicked: function (e) {
                    if (e.data.add_row == '2') {
                        for (var i = 1; i < $scope.itemcolumns.length; i++) {
                            $scope.itemcolumns[i].editableBak = $scope.itemcolumns[i].editable;
                            $scope.itemcolumns[i].editable = true;
                        }
                    } else {
                        for (var i = 1; i < $scope.itemcolumns.length; i++) {
                            if ($scope.itemcolumns[i].editableBak != undefined)
                                $scope.itemcolumns[i].editable = $scope.itemcolumns[i].editableBak;
                        }

                        $scope.itemcolumns[$scope.getIndexByField('itemcolumns', 'erp_code')].editable = false;
                        $scope.itemcolumns[$scope.getIndexByField('itemcolumns', 'pi_no')].editable = false;
                        $scope.itemcolumns[$scope.getIndexByField('itemcolumns', 'inspection_batchno')].editable = false;

                        if (e.data.saleorder_type == '5') {
                            $scope.itemcolumns[$scope.getIndexByField('itemcolumns', 'erp_code')].editable = true;
                            $scope.itemcolumns[$scope.getIndexByField('itemcolumns', 'pi_no')].editable = true;
                            $scope.itemcolumns[$scope.getIndexByField('itemcolumns', 'inspection_batchno')].editable = true;
                        }
                    }
                },
                groupSelectsChildren: false, // one of [true, false]
            ...
            $scope.check_warn_sum_id = function () {
                var aolines = $scope.gridGetData("itemoptions");
                ...
                // $scope.gridSetData("boxlineoptions", $scope.gridGetData("boxlineoptions"));
            }
            ...
            $scope.set_line_gw_nw_pack_rule = function (boxs, columnName, data) {
                ...
                for (var j = 0; j < boxs.length; j++) {
                    var boxline = boxs[j].sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines;
                    var totalNumber = 0;
            ...
            $scope.a_select_lc = function () {
                var itemline = $scope.gridGetRow("itemoptions");
                $scope.selectlc([itemline], false, false, false);
            }

            $scope.a_copy_lc = function () {
                var item = $scope.gridGetRow("itemoptions");
                if (!item) {
        ...
        //linepartoptions
        {
            ...
            $scope.addpartitem = function () {
                if ($scope.checkHavePart) {
                    $scope.gridAddItem('linepartoptions', {});
                } else {
            ...
            $scope.fisscellchange = function () {
                ...
                var nodes = $scope.linepartoptions.api.getModel().rootNode.childrenAfterGroup;
                var cell = $scope.linepartoptions.api.getFocusedCell()
                var field = cell.column.colDef.field;
                ...
                $scope.linepartoptions.api.refreshCells(nodes, key);
            }


            $scope.linepartoptions = {
                rowGroupPanelShow: 'onlyWhenGrouping', // on of ['always','onlyWhenGrouping']
                pivotPanelShow: 'always', // on of ['always','onlyWhenPivoting']
                groupKeys: undefined,
                groupHideGroupColumns: false,
                ...
                showToolPanel: false,
                checkboxSelection: function (params) {
                    var isGrouping = $scope.linepartoptions.columnApi.getRowGroupColumns().length > 0;
                    return params.colIndex === 0 && !isGrouping;
                },
                icons: {
                    columnRemoveFromGroup: '<i class="fa fa-remove"/>',
        ...
        //boxlineoptions
        {
            $scope.autogeneratebox = function () {
                var gridData = $scope.gridGetData("boxlineoptions");
                BasemanService.RequestPost("sale_ship_warn_c_header", "createitemlineno", {box_nos: gridData.length})
                    .then(function (data) {
                        var result = data.sale_ship_warn_c_lineofsale_ship_warn_c_headers;
                        for (var i = 0; i < gridData.length; i++) {
                            if (gridData[i].ref_box_no == "" || gridData[i].ref_box_no == undefined) {
                                gridData[i].ref_box_no = result[i].ref_box_no;
                            }
                        }
                        $scope.gridSetData("boxlineoptions", gridData);
                    })
            ...
            $scope.rowClicked = function (e) {
                if (e == undefined) {
                    var forcusRow = $scope.gridGetRow('boxlineoptions');
                    if (!forcusRow) {
                        $scope.gridSetData('prearroptions', []);
                        $scope.set_wait_datas();
                        return;
                    }
                    $scope.gridSetData('prearroptions', forcusRow.sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines);
                    $scope.set_wait_datas();
                    return
                }
                if (e.data) {
                    if (e.data.sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines == undefined) {
                        e.data.sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines = []
                    }
                    $scope.gridSetData('prearroptions', e.data.sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines);
                }
            ...
            $scope.cabDelLine = function () {
                ...
                $scope.gridDelItem('boxlineoptions', "seq", true);
                $scope.set_wait_datas();
            }
            ...
            $scope.calboxlineAll = function () {
                ...
                for (var m = 0; m < boxlines.length; m++) {
                    ...
                    var datas = boxlines[m].sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines
            ...
            $scope.boxlineoptions = {
                ...
                showToolPanel: false,
                checkboxSelection: function (params) {
                    var isGrouping = $scope.boxlineoptions.columnApi.getRowGroupColumns().length > 0;
                    return params.colIndex === 0 && !isGrouping;
                },
                icons: {
                    columnRemoveFromGroup: '<i class="fa fa-remove"/>',
            ...
            $scope.boxlinecolumns = [
                {
                    ...
                    headerName: "操作", field: "operate", editable: true, filter: 'set', width: 60,
                    cellEditor: "下拉框",
                    enableRowGroup: true,
                    enablePivot: true,
                    enableValue: true,
                    floatCell: true,
                    hide: true,
                    cellEditorParams: {values: [{value: 2, desc: "取消"}, {value: 1, desc: ""}]},
                }, {
        ...
        //prearroptions
        {
                ...
                if (forcusRow.box_type == "" || forcusRow.box_type == undefined) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        if (ref_box_no == data[i].ref_box_no) {
                            forcusRow = data[i];
                            $scope["boxlineoptions"].api.setFocusedCell(i, "box_type");
                            break;
                        }
                    }
                }
                $scope.selectGridDelItem('prearroptions');
                forcusRow.sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines = $scope.gridGetData('prearroptions');
                $scope.gridUpdateRow('boxlineoptions', forcusRow);
            ...
            $scope.copyitem = function () {
                ...
                var boxlines_Bak = $scope.gridGetData("boxlineoptions");
                if ($scope['boxlineoptions'].api.getFocusedCell() == null) {
                    index = 0;
                } else {
                    index = $scope['boxlineoptions'].api.getFocusedCell().rowIndex;
                }
                ...
                HczyCommon.copyobj($scope.boxlineoptions, $scope.FrmInfo.options)

                HczyCommon.copyobj($scope.boxlinecolumns, $scope.FrmInfo.columns)
                ...
                BasemanService.openFrm("views/commonline.html", commonline, $scope, "", "lg").result
                    .then(function (data) {
                        ...
                        for (var n = 0; n < data.length; n++) {
                            var isexists = false
                            var preData = data[n].sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines || [];
                            ...
                            data[n].sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines = preData
                        }
                        $scope.calboxlineAll();
                        $scope.gridSetData("sumoptions", sums, "seq1");
                        $scope.set_wait_datas();
                    })
            ...
            $scope.set_wait_datas = function () {
                ...
                var sums = [];
                for (var i = 0; i < boxs.length; i++) {
                    if (boxs[i].sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines == undefined) {
                        continue;
                    }
                    for (var j = 0; j < boxs[i].sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines.length; j++) {
                        sums.push(boxs[i].sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines[j]);
                    }
                }
                $scope.gridSetData("sumoptions", sums, "seq1");
                for (var i = 0; i < sums.length; i++) {
        ...
        //waitarroptions
        {
            ...
            $scope.load = function () {
                ...
                var focusRow = $scope.gridGetRow('boxlineoptions', "First");
                ...
                focusRow.sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines = preData
                $scope.gridUpdateRow('boxlineoptions', focusRow);
            ...
            $scope.calBoxline = function (focusRow) {
                ...
                if (focusRow == undefined) {
                    focusRow = $scope.gridGetRow('boxlineoptions') || $scope.gridGetData('boxlineoptions')[0];
                }
                var datas = focusRow.sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines;
                var total_pack_rule = 0, total_unit_gw = 0, total_unit_nw = 0, pack_style = 0;
                for (var i = 0; i < datas.length; i++) {
                    total_pack_rule += Number(datas[i].total_tj);
                ...
                var nodes = $scope['boxlineoptions'].api.getModel().rootNode.allLeafChildren;
                var key = ["seq", "total_pack_rule", "pack_style", "total_unit_gw", "total_unit_nw", "amt_fee1", "amt_fee2"];
                $scope["boxlineoptions"].api.refreshCells(nodes, key);
            }
        ...
        //sumoptions
        {
            $scope.sumoptions = {
                ...
                showToolPanel: false,
                checkboxSelection: function (params) {
                    var isGrouping = $scope.sumoptions.columnApi.getRowGroupColumns().length > 0;
                    return params.colIndex === 0 && !isGrouping;
                },
                icons: {
                    columnRemoveFromGroup: '<i class="fa fa-remove"/>',
        ...
        //packageoptions
        {
            $scope.addtobox = function () {
                ...
                var boxline = $scope.gridGetData('boxlineoptions');
                for (var i = 0; i < boxline.length; i++) {
                ...
                $scope.FrmInfo = {
                    title: '装入柜',
                    options: {},
                    datas: $scope.gridGetData('boxlineoptions'),
                    columns: [],
                    type: 'checkbox'
                }
                HczyCommon.copyobj($scope.boxlineoptions, $scope.FrmInfo.options)
            ...
            $scope.getsearch_packgage = function () {
                ...
                BasemanService.RequestPost("sale_ship_warn_c_header", "getpackage2", {
                    warn_id: $scope.data.currItem.warn_id,
                    warn_no: $scope.data.currItem.item_desc
                }).result.then(function (data) {
                    var nodes = $scope.gridGetNodes("")
                    for (var i = 0; i < data.sale_ship_warn_c_package_lineofsale_ship_warn_c_headers.length; i++) {
                        var obj = data.sale_ship_warn_c_package_lineofsale_ship_warn_c_headers[i];
                        for (var j = 0; j < nodes.length; j++) {
            ...
            $scope.sale_prod_packages_earch = function (flag) {
                ...
                BasemanService.openFrm("views/saleman/sale_ship_warn_c_header_package_search.html", sale_prod_packages_earch, $scope, "", "lg").result
                    .then(function () {
                    })
...

    {
        ...
        BasemanService.RequestPostAjax("base_search", "searchdict", {dictcode: "pro_type"})
            .then(function (data) {
                ...
                if ($scope.getIndexByField('sumcolumns', 'pro_type')) {
                    $scope.sumcolumns[$scope.getIndexByField('sumcolumns', 'pro_type')].cellEditorParams.values = pro_types;
                }
            });
        ...
        BasemanService.RequestPostAjax("base_search", "searchdict", {dictcode: "box_type"}).then(function (data) {
            ...
            if ($scope.getIndexByField('boxlinecolumns', 'box_type')) {
                $scope.boxlinecolumns[$scope.getIndexByField('boxlinecolumns', 'box_type')].cellEditorParams.values = box_types;
            }
    ...
    /**其它页面跳转及发货通知单、报关单自动生成*/
    {
        ...
        $scope.buttonClick3 = function () {
            ...
            $scope.FrmInfo = {
                ...
                "          from sale_ship_warn_c_line_sum\n" +
        ...
        $scope.autonoticenew = function () {
            ...
            BasemanService.RequestPost("sale_ship_warn_c_header", "autonoticenew", {warn_id: $scope.data.currItem.warn_id}).then(
                function () {
        ...
        $scope.autocustoms = function () {
            ...
            BasemanService.RequestPost("sale_ship_warn_c_header", "autocustoms", {warn_id: $scope.data.currItem.warn_id}).then(
                function () {
    ...
    $scope.changePricetype = function () {
        ...
        $scope["itemoptions"].api.selectAll();
        $scope.delaoline();
        $scope.gridSetData("enquiryoptions", []);
        $scope.gridSetData("lcoptions", []);
        $scope.gridSetData("linepartoptions", []);
    ...
    $scope.waitSetDatas = function () {
        var sum = $scope.data.currItem.sale_ship_warn_c_line_sumofsale_ship_warn_c_headers;
        var line = $scope.data.currItem.sale_ship_warn_c_lineofsale_ship_warn_c_headers;
    ...
    if(window.userbean.stringofrole.indexOf("admin")==-1&&window.userbean.stringofrole.indexOf("仓管员")==-1){
        $scope.can_export5=false;
    }else{
        $scope.can_export5=true;
    }

    $scope.refresh_after = function () {
        if (window.userbean.stringofrole.indexOf("船务") != -1) {// && $scope.data.currItem.currprocname == ""
            $scope.itemcolumns[$scope.getIndexByField("itemcolumns", "note")].editable = true;
            $scope.itemcolumns[$scope.getIndexByField("itemcolumns", "ab_votes")].editable = true;
            $scope.linepartcolumns[$scope.getIndexByField("linepartcolumns", "ab_votes")].editable = true;
            $scope.auth_right.iscw = true;
        }

        if (window.userbean.stringofrole.indexOf("单证") != -1) {// && $scope.data.currItem.currprocname == ""
            var columns = $scope.lcoptions.defaultColumns
            for (var i = 0; i < $scope.lccolumns.length; i++) {
                $scope.lccolumns[i].editable = columns[i].editable;
            }
        }
        $scope.data.currItem.change_type=Number($scope.data.currItem.change_type);
        $scope.partSummary();
        $scope.waitSetDatas();
        $scope.gridSetData("boxlineoptions", $scope.data.currItem.sale_ship_warn_c_box_lineofsale_ship_warn_c_headers);
        $scope.set_wait_datas();
        $scope.is_change();
    }
    $scope.save_before = function () {
        ...
        var obj = {};
        var msg = [];
        for (var i = 0; i < $scope.data.currItem.sale_ship_warn_c_line_sumofsale_ship_warn_c_headers.length; i++) {
            obj = $scope.data.currItem.sale_ship_warn_c_line_sumofsale_ship_warn_c_headers[i];
            if (obj.add_row == 2) {
        ...
        for (var j = 0; j < $scope.data.currItem.sale_ship_warn_c_box_lineofsale_ship_warn_c_headers.length; j++) {
            var boxline = $scope.data.currItem.sale_ship_warn_c_box_lineofsale_ship_warn_c_headers[j];
            boxline.box_address = "宁波奥克斯外贸仓库";
            if (boxline.sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines == undefined) {
                continue
            }
            for (var i = 0; i < boxline.sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines.length; i++) {
                obj = boxline.sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines[i];
                if (obj.add_row == 2) {
                    if (obj.item_name == undefined || obj.item_name == "") {
                        obj.item_name = obj.cust_spec || "";
                    }
        ...
        var packages = $scope.data.currItem.sale_ship_warn_c_package_lineofsale_ship_warn_c_headers;
    ...
    $scope.copyboxtype = function () {
        var item = $scope.gridGetRow("boxlineoptions");
        if (item == false) {
        ...
        BasemanService.openFrm("views/Pop_copy_Line.html", PopCopyLineController, $scope)
            ...
            for (i = 0; i < result.lines; i++) {
                ...
                $scope.gridAddItem("boxlineoptions", obj);
                $scope.data.currItem.box_qty = $scope.gridGetData("boxlineoptions").length;
                $scope.autogeneratebox();
            }
        });
    };
    ...
    /**导出excel*/
    {
        ...
        $scope.export = function () {
            ...
            BasemanService.RequestPost("sale_ship_warn_c_header", "exporttoexcel", {'warn_id': $scope.data.currItem.warn_id})
                .then(function (data) {
        ...
        $scope.export1 = function () {
            ...
            BasemanService.RequestPost("sale_ship_warn_c_header", "exporttoexcel1", {'warn_id': $scope.data.currItem.warn_id})
                .then(function (data) {
                    if (data.docid != undefined && Number(data.docid) != 0) {
                        var fileurl = '/downloadfile.do?docid=' + data.docid + '&loginguid=' + window.strLoginGuid + '&t=' + new Date().getTime();
                        window.open(fileurl, '_blank', 'height=100, width=400, top=0,left=0, toolbar=no,menubar=no, scrollbars=no, resizable=no,location=no, status=no');
        ...
        $scope.export2 = function () {
            ...
            BasemanService.RequestPost("sale_ship_warn_c_header", "exporttoexcel2", {'warn_id': $scope.data.currItem.warn_id})
                .then(function (data) {
                    if (data.docid != undefined && Number(data.docid) != 0) {
                        var fileurl = '/downloadfile.do?docid=' + data.docid + '&loginguid=' + window.strLoginGuid + '&t=' + new Date().getTime();
                        window.open(fileurl, '_blank', 'height=100, width=400, top=0,left=0, toolbar=no,menubar=no, scrollbars=no, resizable=no,location=no, status=no');
        ...
        $scope.export3 = function () {
            ...
            BasemanService.RequestPost("sale_ship_warn_c_header", "exporttoexcel3", {'warn_id': $scope.data.currItem.warn_id})
                .then(function (data) {
                    if (data.docid != undefined && Number(data.docid) != 0) {
                        var fileurl = '/downloadfile.do?docid=' + data.docid + '&loginguid=' + window.strLoginGuid + '&t=' + new Date().getTime();
                        window.open(fileurl, '_blank', 'height=100, width=400, top=0,left=0, toolbar=no,menubar=no, scrollbars=no, resizable=no,location=no, status=no');
        ...
        $scope.export4 = function () {
            ...
            BasemanService.RequestPost("sale_ship_warn_c_header", "exporttoexcel4", {'warn_id': $scope.data.currItem.warn_id})
                .then(function (data) {
                    if (data.docid != undefined && Number(data.docid) != 0) {
                        var fileurl = '/downloadfile.do?docid=' + data.docid + '&loginguid=' + window.strLoginGuid + '&t=' + new Date().getTime();
                        window.open(fileurl, '_blank', 'height=100, width=400, top=0,left=0, toolbar=no,menubar=no, scrollbars=no, resizable=no,location=no, status=no');
    ...
    $scope.validate = function () {
        ...
        for (var i = 0; i < $scope.data.currItem.sale_ship_warn_c_lc_lineofsale_ship_warn_c_headers.length; i++) {
            obj = $scope.data.currItem.sale_ship_warn_c_lc_lineofsale_ship_warn_c_headers[i];
            linemsg = "";
        ...
        if ($scope.data.currItem.pay_style == "1") {
            for (var i = 0; i < $scope.data.currItem.sale_ship_warn_c_box_lineofsale_ship_warn_c_headers.length; i++) {
                obj = $scope.data.currItem.sale_ship_warn_c_box_lineofsale_ship_warn_c_headers[i];
                if (1) {
                }
            }
        }
    ...
    $scope.wfstart_validDate = function () {
        ...
        var data1 = $scope.gridGetData('itemoptions');
        for (var j = 0; j < data1.length; j++) {
            if(data1[j].sj_type==7){continue;}
    ...
    $scope.warn_wfstart = function (e) {
        ...
        for(var i=0;i<$scope.data.currItem.sale_ship_warn_c_box_lineofsale_ship_warn_c_headers.length;i++){
            obj=$scope.data.currItem.sale_ship_warn_c_box_lineofsale_ship_warn_c_headers[i];
            if(obj.sale_ship_warn_c_line_sumofsale_ship_warn_c_box_lines.length==0){
                msg.push("第"+obj.seq+"的货柜没有使用，请删除!")
            }
        }
        if(msg.length>0){
            BasemanService.notice(msg);
        ...
        for (var i = 0; i < $scope.data.currItem.sale_ship_warn_c_package_lineofsale_ship_warn_c_headers.length; i++) {
            obj = $scope.data.currItem.sale_ship_warn_c_package_lineofsale_ship_warn_c_headers[i];
    ...
    /**导出excel*/
    {
        ...
        $scope.exportjy1 = function () {
            ...
            BasemanService.RequestPost("sale_ship_warn_c_header", "exporttoexceljy1", {'warn_c_id': $scope.data.currItem.warn_c_id})
                .then(function (data) {
                    if (data.docid != undefined && Number(data.docid) != 0) {
                        var fileurl = '/downloadfile.do?docid=' + data.docid + '&loginguid=' + window.strLoginGuid + '&t=' + new Date().getTime();
                        window.open(fileurl, '_blank', 'height=100, width=400, top=0,left=0, toolbar=no,menubar=no, scrollbars=no, resizable=no,location=no, status=no');
        ...
        $scope.exportjy2 = function () {
            ...
            BasemanService.RequestPost("sale_ship_warn_c_header", "exporttoexceljy2", {'warn_c_id': $scope.data.currItem.warn_c_id})
                .then(function (data) {
                    if (data.docid != undefined && Number(data.docid) != 0) {
                        var fileurl = '/downloadfile.do?docid=' + data.docid + '&loginguid=' + window.strLoginGuid + '&t=' + new Date().getTime();
                        window.open(fileurl, '_blank', 'height=100, width=400, top=0,left=0, toolbar=no,menubar=no, scrollbars=no, resizable=no,location=no, status=no');
        ...
        $scope.exportjy3 = function () {
            ...
            var postdata = {'warn_c_id': $scope.data.currItem.warn_c_id};
            if ($scope.cntoptions) {
                postdata.sale_ship_warn_c_lc_lineofsale_ship_warn_c_headers = $scope.selectGridGetData("cntoptions");
            }
            BasemanService.RequestPost("sale_ship_warn_c_header", "exporttoexceljy3", postdata)
                .then(function (data) {
                    if (data.docid != undefined && Number(data.docid) != 0) {
                        var fileurl = '/downloadfile.do?docid=' + data.docid + '&loginguid=' + window.strLoginGuid + '&t=' + new Date().getTime();
                        window.open(fileurl, '_blank', 'height=100, width=400, top=0,left=0, toolbar=no,menubar=no, scrollbars=no, resizable=no,location=no, status=no');
...
//加载控制器
billmanControllers
    .controller('sale_ship_warn_c_headerEdit', sale_ship_warn_c_headerEdit)
