...
function sale_year_sell_bud_headerzf($scope, $location, $rootScope, $modal, notify, $timeout, BasemanService, $state, localeStorageService, FormValidatorService) {
    //继承基类方法
    sale_year_sell_bud_headerzf = HczyCommon.extend(sale_year_sell_bud_headerzf, ctrl_bill_public);
    sale_year_sell_bud_headerzf.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService]);
    //设置当前单据对象基本信息
    $scope.objconf = {
        ...
        FrmInfo: {},
        grids: [
          {optionname: 'options_11', idname: 'sale_year_sell_bud_lineofsale_year_sell_bud_headers'},
        ]
    };
    /******************页面隐藏****************************/
    $scope.show_11 = true;
...
//加载控制器
salemanControllers
    .controller('sale_year_sell_bud_headerzf', sale_year_sell_bud_headerzf);
