...
function sale_customs_header_lt($scope, $location, $rootScope, $modal, notify, $timeout, BasemanService, $state, localeStorageService, FormValidatorService) {
    //继承基类方法
    sale_customs_header_lt = HczyCommon.extend(sale_customs_header_lt, ctrl_bill_public);
    sale_customs_header_lt.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService]);
    //设置当前单据对象基本信息
    $scope.objconf = {
...
$scope.search = function () {
	...
	var postdata = { flag:2,
			...
			create_time: $scope.data.currItem.start_time,
			update_time: $scope.data.currItem.update_time
        };
 BasemanService.RequestPost("sale_customs_header", "search", postdata)
        .then(function(data){
            $scope.data.currItem.sale_customs_headers=data.sale_customs_headers;
             $scope.options_13.api.setRowData(data.sale_customs_headers);
        });
}
	...
	$scope.select3 = function () {
        $scope.FrmInfo = {
	        ...
	        postdata:{},
/*			sqlBlock: "scporg.Stat =2 and OrgType in (5, 14)",*/
            backdatas: "sale_customs_headers",
...
$scope.columns_13 = [
        {
            ...
            floatCell: true
                ...
                headerName: "合同号", field: "cpi_no", editable: false, filter: 'set', width: 100,
                cellEditor: "文本框",
            ...
            headerName: "报关金额", field: "total_amt", editable: false, filter: 'set', width: 150,
            cellEditor: "文本框",
            ...
            headerName: "调整金额", field: "modify_amt", editable: false, filter: 'set', width: 150,
            cellEditor: "浮点框",
            ...
            headerName: "调整时间", field: "sap_date", editable: false, filter: 'set', width: 150,
            cellEditor: "浮点框",
...
//加载控制器
basemanControllers
    .controller('sale_customs_header_lt', sale_customs_header_lt);
