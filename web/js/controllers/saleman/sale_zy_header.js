...
function sale_zy_header($scope, $location, $rootScope, $modal, $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService){
    //设置当前对象名及主键名
    $scope.objconf = {
        classid: "sale_pi_header",
        key: "pi_id",
        nextStat: "sale_zy_headerEdit",
        classids: "sale_pi_headers",
        postdata:{
            sqlwhere: "nvl(bill_flag,0)=2 and pi_no like 'ZY%'",
        },
        thead:[],
        grids:[{optionname:'viewOptions', idname:'contains'}]
    };

    $scope.headername="散件专用订单";
    sale_zy_header = HczyCommon.extend(sale_zy_header,ctrl_view_public);
    sale_zy_header.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
...
//加载控制器
basemanControllers
    .controller('sale_zy_header',sale_zy_header);
