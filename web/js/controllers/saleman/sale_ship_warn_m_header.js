...
function sale_ship_warn_m_header($scope, notify, $modal, $state, $timeout, $location, BasemanService, localeStorageService, $rootScope) {
    //继承基类方法
    sale_ship_warn_m_header = HczyCommon.extend(sale_ship_warn_m_header, ctrl_view_public);
    sale_ship_warn_m_header.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal,
        $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService]);

    //设置当前对象名及主键名
    $scope.objconf = {
        classid: "sale_ship_warn_m_header",
        key: "warn_m_id",
        nextStat: "sale_ship_warn_m_headerEdit",
        classids: "sale_ship_warn_m_headers",
        sqlBlock: "1=1",
        thead: [],
        grids: [{optionname: 'viewOptions', idname: 'contains'}]
    }
    $scope.headername = "出货预告作废";
    ...
    $scope.viewColumns = [
        ...
        {
            headerName: "作废单号", field: "warn_m_no",editable: false, filter: 'set',  width: 150,
            cellEditor:"文本框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
...
// 产品资料
promanControllers
    .controller('sale_ship_warn_m_header', sale_ship_warn_m_header)
