...
function sale_prod_desc_headerEdit($scope, $location, $rootScope, $modal, notify, $timeout, BasemanService, $state, localeStorageService, FormValidatorService) {
    //继承基类方法
    sale_prod_desc_headerEdit = HczyCommon.extend(sale_prod_desc_headerEdit, ctrl_bill_public);
    sale_prod_desc_headerEdit.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService]);
    //设置当前单据对象基本信息
    $scope.objconf = {
        name: "sale_prod_desc_header",
        key: "desc_id",
        wftempid: "10155",
        FrmInfo: {},
        grids: [
            {
                ...
                idname: 'sale_prod_h_lineofsale_prod_desc_headers',
                line: {optionname: "options_23", idname: "sale_prod_lineofsale_prod_h_lines"}
            },//订单明细  分体机	
            {
                optionname: 'options_41',
                idname: 'sale_prod_break_headerofsale_prod_desc_headers',
    ...
    $scope.refresh_after = function () {
        ...
        if (parseInt($scope.data.currItem.have_custpo) == 1) {
			for(var i=0;i<$scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers.length;i++){
				for(var j=0;j<$scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[i].sale_prod_break_itemallofsale_prod_break_headers.length;j++){
				$scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[i].sale_prod_break_itemallofsale_prod_break_headers[j].pocustno="/";
	...
	$scope.prodno_search =function(){
        ...
        BasemanService.open(CommonPopController, $scope)
			...
			BasemanService.RequestPost("sale_prod_header", "select", {prod_id: $scope.data.currItem.prod_id}).then(function (data) {				
				...
				var name1=name.replace(/sale_prod_headers/g,"sale_prod_desc_headers");
							...
							for(var j=0;j<$scope.data.currItem[name1].length;j++){
							    for(name2 in $scope.data.currItem[name1][j]){
								  if($scope.data.currItem[name1][j][name2] instanceof Array){
									  var name3=name2.replace(/sale_prod_headers/g,"sale_prod_desc_headers");
				...
				for(name in $scope.data.currItem){
					if($scope.data.currItem[name]instanceof Array){
						var name1="sale_prod_h_lineofsale_prod_desc_headers";
						var name2="sale_prod_break_headerofsale_prod_desc_headers";
						var name3="sale_prod_lineofsale_prod_h_lines";
						var name4="sale_prod_break_itemofsale_prod_break_headers";
						var name5="sale_prod_break_lineofsale_prod_break_headers";
						var name6="sale_prod_break_itemallofsale_prod_break_headers";
						var name7="sale_bill_break_itemofsale_prod_break_headers";
				...
				$scope.options_21.api.setRowData($scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers);
				if($scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers[0]){
					if($scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers[0].sale_prod_lineofsale_prod_h_lines){
						$scope.options_23.api.setRowData($scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers[0].sale_prod_lineofsale_prod_h_lines);
					}//分体机			
				};				
				$scope.options_41.api.setRowData($scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers)//方案
				if($scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[0]){
					if($scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[0].sale_prod_break_lineofsale_prod_break_headers){
						$scope.options_42.api.setRowData($scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[0].sale_prod_break_lineofsale_prod_break_headers);
					}//打散方案明细
					if($scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[0].sale_prod_break_itemallofsale_prod_break_headers){
						$scope.options_43.api.setRowData($scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[0].sale_prod_break_itemallofsale_prod_break_headers);
					}//包装方案
					if($scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[0].sale_bill_break_itemofsale_prod_break_headers){
						$scope.options_44.api.setRowData($scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[0].sale_bill_break_itemofsale_prod_break_headers);
					}//包装方案
				}		
        });
	  })
    ...
    /*****************网格处理事件****************************/
    {
        ...
        $scope.rowClicked21 = function (event) {
			//处理光标下移问题
            $scope.deal_rowClicked("options_21", ["options_23"]);
            //分体机==
            if (event.data) {
        ...
        $scope.ptype_name43 = function () {
            ...
            BasemanService.open(CommonPopController, $scope)
                .result.then(function (result) {
                    ...
                    $scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[rowidx].sale_bill_break_itemofsale_prod_m_break_headers = data;
        ...
        $scope.addline21 = function () {
            ...
            BasemanService.open(CommonPopController, $scope, "", "lg").result.then(function (items) {
                if (items.length) {
                    ...
                    $scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers = data;
                }
                $scope.options_21.api.setRowData($scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers);
                for (var i = 0; i < $scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers.length; i++) {
                    var h_item = $scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers[i].sale_prod_lineofsale_prod_h_lines;
                    if (h_item == undefined) {
                        h_item = [];
		...
		if(rowidx>0){
          ...
          $scope.options_23.api.setRowData($scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers[rowidx].sale_prod_lineofsale_prod_h_lines);			  
		}else{
		  ...
		  var colKey= $scope.options_21.api.getFocusedCell().column.colId
		  $scope.options_21.api.setFocusedCell(rowidx,colKey);
          $scope.options_23.api.setRowData($scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers[rowidx+1].sale_prod_lineofsale_prod_h_lines); 
		  }
		}		
		//删除配件行
    ...
    document.getElementById('divPIconfBgIframe').src = pcsurl;		
		...
		$scope.ma_no =function(){
			...
			BasemanService.openFrm("views/saleman/ma_no.html", ma_no, $scope, "", "lg")
				...
				$scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers[index].ma_id=mad_ids;
				$scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers[index].ma_no=mad_nos;
			    $scope.options_21.api.setRowData($scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers);		
			})
		...
		$scope.ma_no1 =function(){
			if($scope.options_21.api.getFocusedCell()){
                ...
                BasemanService.open(CommonPopController, $scope)
                    .result.then(function (items) {
						$scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers[index].ma_id=parseInt(items.ma_id);
						$scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers[index].ma_no=(items.ma_no);
						$scope.options_21.api.setRowData($scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers);
					})
		}
        ...
        $scope.addline43 = function () {
            ...
            BasemanService.open(CommonPopController, $scope, "", "lg").result.then(function (data) {
                ...
                $scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[index].sale_prod_break_itemallofsale_prod_break_headers = items;
                for (var i = 0; i < $scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[index].sale_prod_break_itemallofsale_prod_break_headers.length; i++) {
                    $scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[index].sale_prod_break_itemallofsale_prod_break_headers[i].seq = (i + 1);
                    $scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[index].sale_prod_break_itemallofsale_prod_break_headers[i].line_id = (i + 1);
                }
                $scope.options_43.api.setRowData($scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[index].sale_prod_break_itemallofsale_prod_break_headers);
            });
        };
        ...
        $scope.additemLine42 = function () {
            if ($scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[0].break_name == "" || $scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[0].break_name == undefined) {
...
//		postdata.item_code=node[rowidx].data.item_code;
        ...
        $scope.cancel43 = function () {
            ...
            data1.push(data[0]);
            var rowidx = $scope.options_41.api.getFocusedCell().rowIndex;
            $scope.data.currItem.sale_prod_break_headerofsale_prod_desc_headers[rowidx].sale_m_break_lineofsale_m_break_headers = data1;
        ...
        $scope.columns_61 = [
            {
                ...
                headerName: "允许删除", field: "allow_delete", editable: true, filter: 'set', width: 100,
                cellEditor: "复选框",
                enableRowGroup: true,
                enablePivot: true,
                enableValue: true,
    ...
    $scope.validate = function () {
        ...
        var errorlist = [];
        var data = $scope.data.currItem.sale_prod_h_lineofsale_prod_desc_headers;
        for (var i = 0; i < data.length; i++) {
    ...
    $scope.save_before = function () {
        ...
        if ($scope.data.currItem.stat > 1) {
		    ...
		    for(var i=0;i<postdata.sale_prod_break_headerofsale_prod_desc_headers.length;i++){
				for(var j=0;j<postdata.sale_prod_break_headerofsale_prod_desc_headers[i].sale_prod_break_itemallofsale_prod_break_headers.length;j++){
				postdata.sale_prod_m_break_itemallofsale_prod_m_headers.push(postdata.sale_prod_break_headerofsale_prod_desc_headers[i].sale_prod_break_itemallofsale_prod_break_headers[j]);
				}
			}
            postdata.flag = 2;
        } else {
...
//加载控制器
basemanControllers
    .controller('sale_prod_desc_headerEdit', sale_prod_desc_headerEdit);
