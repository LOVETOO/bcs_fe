...
function sale_pi_headerEdit($scope, $http, $rootScope, $modal, $location, $timeout, BasemanService, $state, localeStorageService, FormValidatorService, HistoryDataService,notify) {
    //继承基类方法
    ...
    $scope.objconf = {
        ...
        key: "pi_id",
        wftempid:10004,
        FrmInfo: {sqlBlock:" pi_no like '%PI%'"},
        grids: [{optionname: 'options_11', idname: 'sale_pi_pay_lineofsale_pi_headers'},//资金预览
            {optionname: 'options_12', idname: 'sale_pi_feeofsale_pi_headers'},//费用明细
            {optionname: 'options_13', idname: 'sale_pi_box_lineofsale_pi_headers'},//柜型柜量
            {optionname: 'options_14', idname: 'sale_pi_money_lineofsale_pi_headers'},//款项明细
            {optionname: 'options_15', idname: 'sale_pi_area_attributeofsale_pi_headers'},//机型参数
...

            {
                ...
                idname: 'sale_pi_break_headerofsale_pi_headers',
                line: {optionname: "options_42", idname: "sale_pi_break_lineofsale_pi_break_headers"}
            },//打散-包装方案  打散方案明细（左）
            {
                optionname: 'options_41',
                idname: 'sale_pi_break_headerofsale_pi_headers',
                line: {optionname: "options_43", idname: "sale_pi_break_itemofsale_pi_break_headers"}
            },//打散-包装方案  打散方案明细（右）
            {
                optionname: 'options_41',
                idname: 'sale_pi_break_headerofsale_pi_headers',
                line: {optionname: "options_44", idname: "sale_pi_break_itemallofsale_pi_break_headers"}
            },//打散-包装方案  包装方案
			{
                optionname: 'options_41',
                idname: 'sale_pi_break_headerofsale_pi_headers',
			...
			{optionname: 'options_51', idname: 'sale_pi_conf_bomofsale_pi_headers'},//替换明细
        ]
    };
	...
	$scope.summary =function(){
		var sum1=0,sum2=0;
		var row=$scope.data.currItem.sale_pi_break_headerofsale_pi_headers;
    ...
    $scope.clearinformation = function () {
        ...
        $scope.data.currItem = {
			...
			bill_type:1,
			bill_flag:1,
			seaport_out_name:"NINGBO",
			seaport_out_code:"NINGBO",
			seaport_out_type:"1",
			seaport_out_id:"771"
    ...
    $scope.validate = function () {
		...
		for(var i=0;i<nodes1.length;i++){
			...
			if(nodes1[i].data.cust_item_name==""||nodes1[i].data.cust_item_name==undefined){
				BasemanService.notice("第"+(i+1)+"客户型号为空","alert-warning");
			    return;
			}
		}
		for(var i=0;i<nodes1.length;i++){
			if(parseInt(nodes1[i].data.line_type)!=4){
				if(parseFloat(nodes1[i].data.guide_p6||0)==0||parseFloat(nodes1[i].data.p4||0)==0||parseFloat(nodes1[i].data.std_p4||0)==0){
					BasemanService.notice("第"+(i+1)+"行指导价、业务结算价、标准结算价不能为0","alert-warning");
			        return;
				}
			}
		}
		...
		for(var i=0;i<data.length;i++){
			sum+=parseFloat(data[i].pay_ratio);
		}
		if(sum!=100){
			BasemanService.notice("资金预览付款比例和不为0","alert-warning")
			return;
		}
		if(k==0&&l!=0){
	...
	$scope.save_before =function(){
		if($scope.data.currItem.sale_pi_pay_lineofsale_pi_headers){
			var sum=0;
		for(var i=0;i<$scope.data.currItem.sale_pi_pay_lineofsale_pi_headers.length;i++){
			sum+=parseFloat($scope.data.currItem.sale_pi_pay_lineofsale_pi_headers[i].amount||0)
		}
		if(sum!=parseFloat($scope.data.currItem.amt_total||0)){
		for(var i=0;i<$scope.data.currItem.sale_pi_pay_lineofsale_pi_headers.length;i++){
			$scope.data.currItem.sale_pi_pay_lineofsale_pi_headers[i].amount=parseFloat($scope.data.currItem.amt_total||0)*(parseFloat($scope.data.currItem.sale_pi_pay_lineofsale_pi_headers[i].pay_ratio||0))/100
		    }
		 }
		}
	...
	$scope.refresh_after= function(){
		...
		if($scope.options_41.api.getFocusedCell()){
            ...
            $scope.options_42.api.setRowData($scope.data.currItem.sale_pi_break_headerofsale_pi_headers[rowidx].sale_pi_break_lineofsale_pi_break_headers);			
			$scope.options_43.api.setRowData($scope.data.currItem.sale_pi_break_headerofsale_pi_headers[rowidx].sale_pi_break_itemofsale_pi_break_headers);
			$scope.options_44.api.setRowData($scope.data.currItem.sale_pi_break_headerofsale_pi_headers[rowidx].sale_pi_break_itemallofsale_pi_break_headers);
		}
		for(var i=0;i<$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers.length;i++){
			$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].queue=parseInt(i+1);
		}
		...
		if($scope.data.currItem.copy==1){
			...
			$scope.data.currItem.std_flag=0;
			$scope.data.currItem.wfflag=0;
			$scope.data.currItem.wfid=0;
			$scope.data.currItem.stat=1;
			$scope.data.currItem.sale_pi_money_line=[];
			for(var i=0;i<$scope.data.currItem.sale_pi_box_lineofsale_pi_headers.length;i++){
				$scope.data.currItem.sale_pi_box_lineofsale_pi_headers[i].pi_box_id=0;
			}
			$scope.data.currItem.is_prod_comp=0;
			for(var i=0;i<$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers.length;i++){
				$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].already_in_qty=0;
				$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].already_ship_qty=0;
				$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].actual_out_qty=0;
				$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].proded_qty=0;
				$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].warned_qty=0;
				$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].invoice_qty=0;
				$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].invoice_amt=0;
				for(var j=0;j<$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].sale_pi_item_lineofsale_pi_item_h_lines.length;j++){
					$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].sale_pi_item_lineofsale_pi_item_h_lines[j].already_in_qty=0
					$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].sale_pi_item_lineofsale_pi_item_h_lines[j].already_ship_qty=0
					$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].sale_pi_item_lineofsale_pi_item_h_lines[j].actual_out_qty=0
					$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].sale_pi_item_lineofsale_pi_item_h_lines[j].proded_qty=0
					$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].sale_pi_item_lineofsale_pi_item_h_lines[j].warned_qty=0
					$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].sale_pi_item_lineofsale_pi_item_h_lines[j].invoice_qty=0
					$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[i].sale_pi_item_lineofsale_pi_item_h_lines[j].invoice_amt=0
				}
			}
			
			for(var i=0;i<$scope.data.currItem.sale_pi_item_partofsale_pi_headers.length;i++){
				$scope.data.currItem.sale_pi_item_partofsale_pi_headers[i].already_in_qty=0;
				$scope.data.currItem.sale_pi_item_partofsale_pi_headers[i].already_ship_qty=0;
				$scope.data.currItem.sale_pi_item_partofsale_pi_headers[i].actual_out_qty=0;
				$scope.data.currItem.sale_pi_item_partofsale_pi_headers[i].proded_qty=0;
				$scope.data.currItem.sale_pi_item_partofsale_pi_headers[i].warned_qty=0;
				$scope.data.currItem.sale_pi_item_partofsale_pi_headers[i].invoice_qty=0;
				$scope.data.currItem.sale_pi_item_partofsale_pi_headers[i].invoice_amt=0;
			}
			$scope.data.currItem.sale_pi_item_conf2ofsale_pi_headers=[];
			$scope.options_31.api.setRowData($scope.data.currItem.sale_pi_item_conf2ofsale_pi_headers);
			$scope.data.currItem.sale_pi_item_confofsale_pi_headers=[];
			$scope.options_32.api.setRowData($scope.data.currItem.sale_pi_item_confofsale_pi_headers);			
		}
		$scope.summary();
		$scope.authority();			
	}
	...
	$scope.authority =function(){
        ...
        if(mystring.indexOf("销售人员") > -1&&mystring.indexOf("admin")<0){
		   $scope.options_21.columnApi.setColumnsVisible(['price','sale_amt','guide_p6','hguide_hwmlv','std_c_price'], true);
		   $scope.options_22.columnApi.setColumnsVisible(['price','sale_amt','guide_p6','hguide_hwmlv','std_c_price'], true);
		}
		if(mystring.indexOf("admin")>-1||mystring.indexOf("admins")>-1||mystring.indexOf("外总")>-1||mystring.indexOf("事总")>-1){

$scope.options_21.columnApi.setColumnsVisible(['pre_price','pre_guid_price','price','sale_amt','guide_p6','p4','std_p4','hguide_hwmlv','std_c_price','c_price','std_c_cl_cb'], true)
$scope.options_22.columnApi.setColumnsVisible(["pre_price","pre_guid_price","price","sale_amt","guide_p6","p4","std_p4","hguide_hwmlv","std_c_price","c_price","std_c_cl_cb"], true)
		}
		if(mystring.indexOf("admin")>-1||mystring.indexOf("admins")>-1){
			$scope.options_41.columnApi.setColumnsVisible(['ys_price','std_price'], true);
		}
		if(mystring.indexOf("财务部")>-1){
       $scope.options_21.columnApi.setColumnsVisible(['pre_price','pre_guid_price','price','sale_amt','guide_p6','hguide_hwmlv','std_c_price'], true);
       $scope.options_22.columnApi.setColumnsVisible(['pre_price','pre_guid_price','price','sale_amt','guide_p6','hguide_hwmlv','std_c_price'], true);
		}
		if(mystring.indexOf("可查看标准成本")>-1){
	   $scope.options_21.columnApi.setColumnsVisible(['std_p4','std_c_cl_cb'], true);
       $scope.options_22.columnApi.setColumnsVisible(['std_p4','std_c_cl_cb'], true);	
		}
		if(mystring.indexOf("可查看工厂结算价")>-1){
	   $scope.options_21.columnApi.setColumnsVisible(['pre_price','pre_guid_price','price','sale_amt','guide_p6','p4','hguide_hwmlv','std_c_price','c_price'], true);
       $scope.options_22.columnApi.setColumnsVisible(['pre_price','pre_guid_price','price','sale_amt','guide_p6','p4','hguide_hwmlv','std_c_price','c_price'], true);
		}
		if(mystring.indexOf("单证")>-1){
	   $scope.options_21.columnApi.setColumnsVisible(['price','sale_amt','guide_p6','hguide_hwmlv','std_c_price'], true);
       $scope.options_22.columnApi.setColumnsVisible(['price','sale_amt','guide_p6','hguide_hwmlv','std_c_price'], true);
		}
		if(mystring.indexOf("仅查看工厂结算价")>-1){
	   $scope.options_21.columnApi.setColumnsVisible(['p4','c_price'], true);
       $scope.options_22.columnApi.setColumnsVisible(['p4','c_price'], true);
		}

        /**if($scope.data.currItem.currprocname=="技术支持"&&$scope.user_auth.auth5){
		...
		if($scope.user_auth.auth5&&$scope.data.currItem.currprocname=="打散方案维护"){
		for(var i=0;i<$scope.columns_41.length;i++){
				if($scope.columns_41[i].field=="break_name"||$scope.columns_41[i].field=="item_type_name"){
					$scope.columns_41[i].editable=true;
				}
		...
		if(window.strUserId==$scope.data.currItem.creator&&$scope.data.currItem.currprocname=="业务确认"){
			for(var i=0;i<$scope.columns_21.length;i++){
				if($scope.columns_21[i].field=="qty"){
					$scope.columns_21[i].editable=true;
				}
			}
			if($scope.data.currItem.payment_type_name){
				$scope.user_auth.TT = $scope.data.currItem.payment_type_name.indexOf("TT") > -1 ? true : false;
			$scope.user_auth.OA = $scope.data.currItem.payment_type_name.indexOf("OA") > -1 ? true : false;
			$scope.user_auth.LC = $scope.data.currItem.payment_type_name.indexOf("LC") > -1 ? true : false;
			}
		...
		if($scope.options_21.api.getModel().rootNode.childrenAfterSort[0]){
	...
	$scope.wfstart_before =function(){		
        ...
        for(var i=0;i<data.length;i++){
			...
			if(data[i].brand_name==""||data[i].brand_name==undefined){
				BasemanService.notice("品牌名第"+(i+1)+"行为空","alert-warning");
				return;
			}
		}
		 var count=0;
		...
		//散件打散-包装方案控制   散件订单不需要控制打散方案
		/**var data=$scope.gridGetData("options_41");
		for(var i=0;i<data.length;i++){
			if(data[i].break_name==""||data[i].break_name==undefined){
				BasemanService.notice("散件打散-包装方案第"+(i+1)+"行的打散方案为空","alert-warning");
			    return;	
			}
		}*/
	...
	$scope.user_auth.look_auth = mystring.indexOf("可查看标准成本") > -1 ? true : false;
	
	$scope.user_auth.auth1 = mystring.indexOf("大区会计") > -1 ? true : false;
	$scope.user_auth.auth2 = mystring.indexOf("仅查看工厂结算价") > -1 ? true : false;
	$scope.user_auth.auth3 = mystring.indexOf("区域经理") > -1 ? true : false;
	$scope.user_auth.auth4 = mystring.indexOf("大区总监") > -1 ? true : false;
	$scope.user_auth.auth5 = mystring.indexOf("海外技术支持") > -1 ? true : false;
	$scope.user_auth.auth6 = mystring.indexOf("查看方案明细") > -1 ? true : false;
    ...
    $scope.selectcust = function () {
        ...
        BasemanService.open(CommonPopController, $scope)
            ...
            $scope.data.currItem.cust_level = parseInt(result.cust_level);
    ...
    //订单明细  国家
      $scope.area_names21 = function () {
		...
		//定义保存勾选根据的字段
	    $scope.FrmInfo.checkbox_key="areaid";
	    //定义保存勾选根据的值
	    $scope.FrmInfo.checkbox_value=$scope.gridGetData("options_21")[$scope.options_21.api.getFocusedCell().rowIndex]["area_ids"];
        BasemanService.open(CommonPopController, $scope)
            .result.then(function (result) {
            var data = [];
...
//            data[index].apply_price = parseFloat(items.price);
    ...
    $scope.break_name41 = function () {
        ...
        BasemanService.open(CommonPopController, $scope)
			...
			$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[index].sale_pi_break_itemofsale_pi_break_headers=[];
			$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[index].sale_pi_break_itemallofsale_pi_break_headers=[];
			$scope.options_43.api.setRowData($scope.data.currItem.sale_pi_break_headerofsale_pi_headers[index].sale_pi_break_itemofsale_pi_break_headers);
			});
    ...
    $scope.cellchange41 = function () {
            ...
            if(val==""){
			$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[index].sale_pi_break_lineofsale_pi_break_headers=[];	
			$scope.options_42.api.setRowData([]);
			$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[index].sale_pi_break_itemofsale_pi_break_headers=[];
			$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[index].sale_pi_break_itemallofsale_pi_break_headers=[];
			$scope.options_43.api.setRowData($scope.data.currItem.sale_pi_break_headerofsale_pi_headers[index].sale_pi_break_itemofsale_pi_break_headers);
			$scope.options_44.api.setRowData($scope.data.currItem.sale_pi_break_headerofsale_pi_headers[index].sale_pi_break_itemallofsale_pi_break_headers);
			}		
    }
        ...
        if ($scope.data.currItem.customer_payment_typeofcustomers.length > 0) {
            ...
            BasemanService.RequestPost("customer", "getpayline", postdata)
                .then(function (data) {
					...
					$scope.options_11.api.setRowData($scope.data.currItem.sale_pi_pay_lineofsale_pi_headers);
    ...
    $scope.sale_order_type =function(){
		$scope.data.currItem.sale_pi_pay_lineofsale_pi_headers=[];
		$scope.options_11.api.setRowData([])
		$scope.data.currItem.sale_pi_feeofsale_pi_headers=[];
		$scope.options_12.api.setRowData([])
		$scope.data.currItem.sale_pi_box_lineofsale_pi_headers=[];
		$scope.options_13.api.setRowData([])
		$scope.data.currItem.sale_pi_money_lineofsale_pi_headers=[];
		$scope.options_14.api.setRowData([])
		$scope.data.currItem.sale_pi_area_attributeofsale_pi_headers=[];
		$scope.options_15.api.setRowData([])
		$scope.data.currItem.sale_pi_item_mbdataofsale_pi_headers=[];
		$scope.options_16.api.setRowData([])
		
		$scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers=[];
		$scope.options_21.api.setRowData($scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers);
		$scope.options_22.api.setRowData([]);
		$scope.data.currItem.sale_pi_item_partofsale_pi_headers=[];
		...
		$scope.data.currItem.sale_pi_break_headerofsale_pi_headers=[];
		$scope.options_41.api.setRowData($scope.data.currItem.sale_pi_break_headerofsale_pi_headers);
		$scope.options_42.api.setRowData([]);
    ...
    $scope.rowClicked21 = function (event) {
		...
		if(temp.line_type==4){			
			for(var i=0;i<colmun.length;i++){
				if((colmun[i].colDef.editable==true&&colmun[i].colDef.field!="cust_item_name")&&(colmun[i].colDef.editable==true&&colmun[i].colDef.field!="brand_name"&&colmun[i].colDef.field!="qty")){
					colmun[i].colDef.editable=false;
		 ...
		 //$scope.options_21.columnApi.resetColumnState();
		 //$scope.options_22.columnApi.resetColumnState();
    ...
    $scope.rowClicked41 = function (event) {
        if (event.data) {
            //关联打散方案明细左
            if (event.data.sale_pi_break_lineofsale_pi_break_headers == undefined) {
                event.data.sale_pi_break_lineofsale_pi_break_headers = [];
            }
            $scope.options_42.api.setRowData(event.data.sale_pi_break_lineofsale_pi_break_headers);
            //关联打散方案明细右
            if (event.data.sale_pi_break_itemofsale_pi_break_headers == undefined) {
                event.data.sale_pi_break_itemofsale_pi_break_headers = [];
            }
            $scope.options_43.api.setRowData(event.data.sale_pi_break_itemofsale_pi_break_headers);
            //关联包装方案
            if (event.data.sale_pi_break_itemallofsale_pi_break_headers == undefined) {
                event.data.sale_pi_break_itemallofsale_pi_break_headers = [];
            }
            $scope.options_44.api.setRowData(event.data.sale_pi_break_itemallofsale_pi_break_headers);
			//辅料用量汇总
    ...
    $scope.qty21 = function () {
        ...
        itemtemp.sale_amt = parseFloat(val || 0) * parseFloat(itemtemp.price);
        $scope.options_21.api.refreshCells(nodes, ["sale_amt"]);
        $scope.data.currItem.amt_total=parseFloat($scope.data.currItem.amt_total||0)+itemtemp.sale_amt-parseFloat(before);
        if (index != undefined) {
            val = val ? val : 0;
            for (var i = 0; i < pi_item_h_lines.length; i++) {
                if (pi_item_h_lines.length > 0) {
    ...
    $scope.delline21 = function () {
		...
		if(rowidx>0){
		  ...
		  $scope.options_22.api.setRowData($scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[rowidx].sale_pi_item_lineofsale_pi_item_h_lines);		  
		}else{
		  ...
		  var colKey= $scope.options_21.api.getFocusedCell().column.colId
		  $scope.options_21.api.setFocusedCell(rowidx,colKey);
		  $scope.options_22.api.setRowData($scope.data.currItem.sale_pi_item_h_lineofsale_pi_headers[rowidx+1].sale_pi_item_lineofsale_pi_item_h_lines);	  
		  }
		}		
		//删除配件行
    ...
    $scope.addpro_parts = function () {
        ...
        BasemanService.openFrm("views/saleman/part_additem.html", part_additem, $scope, "", "lg")
            .result.then(function (items) {
			if(!items[1].pro_item_partofpro_items){
				items[1].pro_item_partofpro_items=[];
			}
            var data = [];
            var nodes = $scope.options_23.api.getModel().rootNode.childrenAfterSort;
            for (var i = 0; i < nodes.length; i++) {
	...
	$scope.copycuitem =function(){
		...
		object.pi_h_id=0;
		data.push(object);
		for(var i=0;i<object.sale_pi_item_lineofsale_pi_item_h_lines.length;i++){
			object.sale_pi_item_lineofsale_pi_item_h_lines[i].pi_line_id=0;
		}
		$scope.options_21.api.setRowData(data);
	}
	...
	$scope.setresult=function(data,result){
		...
		for(var j=0;j<result.length;j++){
              ...
              re.sale_pi_item_h_lineofsale_pi_headers[0].sale_pi_item_lineofsale_pi_item_h_lines=re.sale_pi_item_lineofsale_pi_headers
...
function fnPIconfBgClose() {
        ...
        BasemanService.openFrm("views/saleman/part_additem.html", part_additem, $scope, "", "lg")
            ...
            if (items[1].pro_item_partofpro_items.length) {
               ...
               $scope.options_23.api.setRowData(data);
                ...
                data1[index].sale_pi_item_lineofsale_pi_item_h_lines[0].sale_amt = parseFloat(data1[index].sale_pi_item_lineofsale_pi_item_h_lines[0].sale_amt || 0)
                + temp.sale_pi_item_lineofsale_pi_item_h_lines[0].sale_amt;
                data1[index].sale_pi_item_lineofsale_pi_item_h_lines[0].price = parseFloat(data1[index].sale_pi_item_lineofsale_pi_item_h_lines[0].price || 0)
    ...
    $scope.addline42 = function () {
        ...
        data.push(item);
		var rowidx = $scope.options_41.api.getFocusedCell().rowIndex;
		$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[rowidx].sale_pi_break_lineofsale_pi_break_headers=data;
	...
	$scope.ptype_nameall = function () {
		...
		for(var i=0;i<$scope.data.currItem.sale_pi_break_headerofsale_pi_headers.length;i++){
			for(var j=0;j<$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[i].sale_pi_break_itemofsale_pi_break_headers.length;j++){
			$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[i].sale_pi_break_itemofsale_pi_break_headers[j].ptype_name=$scope.data.currItem.ptype_name;
			$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[i].sale_pi_break_itemofsale_pi_break_headers[j].ptype_id=$scope.data.currItem.ptype_id;
			$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[i].sale_pi_break_itemallofsale_pi_break_headers[j].ptype_name=$scope.data.currItem.ptype_name;
			$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[i].sale_pi_break_itemallofsale_pi_break_headers[j].ptype_id=$scope.data.currItem.ptype_id;
			}			
		}               		
        $scope.options_43.api.setRowData($scope.data.currItem.sale_pi_break_headerofsale_pi_headers[rowidx].sale_pi_break_itemofsale_pi_break_headers);			
    }
    ...
    //打散-包装方案 打散方案明细(右) 方案类型复制到相同编码机型
	 $scope.copyitem43 = function () {
		...
		for(var i=0;i<$scope.data.currItem.sale_pi_break_headerofsale_pi_headers.length;i++){
			for(var j=0;j<$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[i].sale_pi_break_itemofsale_pi_break_headers.length;j++){
				if($scope.data.currItem.sale_pi_break_headerofsale_pi_headers[i].sale_pi_break_itemofsale_pi_break_headers[j].item_code==nodes[rowidx].data.item_code){
				$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[i].sale_pi_break_itemofsale_pi_break_headers[j].ptype_name=nodes[rowidx].data.ptype_name;
			     }
			}
		}
        $scope.options_43.api.setRowData($scope.data.currItem.sale_pi_break_headerofsale_pi_headers[rowidx1].sale_pi_break_itemofsale_pi_break_headers);
	 }
    //打散-包装方案 包装方案 增加行
	...
	$scope.cancel44 = function () {
		...
		data1.push(data[0]);
		var rowidx = $scope.options_41.api.getFocusedCell().rowIndex;
		$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[rowidx].sale_pi_break_itemallofsale_pi_break_headers=data1;
    ...
    $scope.getpack = function () {
		...
		var node=$scope.options_41.api.getModel().rootNode.childrenAfterSort;
		for (var i = 0; i < node.length; i++) {
			for(var j=0;j<node[i].data.sale_pi_break_itemallofsale_pi_break_headers.length;j++)
            if (node[i].data.sale_pi_break_itemallofsale_pi_break_headers[j].package_name == undefined||node[i].data.sale_pi_break_itemallofsale_pi_break_headers[j].package_name=="") {
                data.push(node[i].data.sale_pi_break_itemallofsale_pi_break_headers[j]);
            }
        }
		$scope.options_47.api.setRowData(data);
	}
	//替换明细
	$scope.time_data1 =function(){
		var postdata={};
		postdata.s_flag=2;
		postdata.pi_no=$scope.data.currItem.pi_no;
		var promise = BasemanService.RequestPost("sale_pi_header", "getitembom", postdata);
		promise.then(function (data) {
			$scope.options_51.api.setRowData(data.sale_pi_conf_bomofsale_pi_headers);
		});
	}
	$scope.time_data2 =function(){
		var postdata={};
		postdata.s_flag=0;
		postdata.pi_no=$scope.data.currItem.pi_no;
		var promise = BasemanService.RequestPost("sale_pi_header", "getitembom", postdata);
    ...
    $scope.item_code46 = function () {
        ...
        promise.then(function (data) {
            ...
            shift[0].children = [];
            //循环递归处理树状数据结构
            //$scope.options_46.api.setRowData(data.sale_pi_item_h_lineofsale_pi_headers);
    ...
    $scope.move46 = function () {
		...
		for(var i=0;i<data2.length;i++){
			...
			data1.push(object1);
			$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[rowidx].sale_pi_break_itemallofsale_pi_break_headers.push(object1);
		}
		for(var i=0;i<node.length;i++){
		...
		$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[rowidx].sale_pi_break_itemofsale_pi_break_headers=(data1);
		//$scope.data.currItem.sale_pi_break_headerofsale_pi_headers[rowidx].sale_pi_break_itemallofsale_pi_break_headers=(data1);
    ...
    $scope.columns_11 = [
		...
		{
            headerName: "资金成本率", field: "interest_rate", editable: false, filter: 'set', width: 150,
            cellEditor: "浮点框",
            //cellchange:$scope.bankBalance,
            enableRowGroup: true,
            enablePivot: true,
    ...
    $scope.columns_12 = [
        ...
        {
            headerName: "订单费用编码", field: "order_fee_code", editable: false, filter: 'set', width: 200,
            cellEditor: "文本框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
    ...
    $scope.columns_41 = [
		...
		{
            headerName: "ys_price", field: "ys_price", editable: false, filter: 'set', width: 100,
			hide:true,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
        ...
        {
            headerName: "std_price", field: "std_price", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
			hide:true,
            enableRowGroup: true,
            enablePivot: true,
...
//包装方案（未维护）
    ...
    $scope.columns_51 = [
        ...
        {
            headerName: "标机名称", field: "item_name", editable: false, filter: 'set', width: 150,
            cellEditor: "文本框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "PDM价差", field: "diffprice", editable: false, filter: 'set', width: 150,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "PDM标准价差", field: "std_diffprice", editable: false, filter: 'set', width: 150,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "替换前物料", field: "bs_item_code", editable: false, filter: 'set', width: 100,
            cellEditor: "文本框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "替换前数量", field: "bs_item_qty", editable: false, filter: 'set', width: 100,
            cellEditor: "整数框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "PDM替换前价格", field: "bs_price", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "PDM替换前标准价格", field: "std_bs_price", editable: false, filter: 'set', width: 150,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "SAP替换前标准价格", field: "std_sap_bs_price", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "替换后数量", field: "as_item_qty", editable: false, filter: 'set', width: 100,
            cellEditor: "整数框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "PDM替换后价格", field: "as_price", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "SAP替换后价格", field: "sap_as_price", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "PDM替换后标准价格", field: "std_as_price", editable: false, filter: 'set', width: 100,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
        ...
        {
            headerName: "SAP替换后标准价格", field: "std_sap_as_price", editable: false, filter: 'set', width: 120,
            cellEditor: "浮点框",
            enableRowGroup: true,
            enablePivot: true,
            enableValue: true,
