...
function sale_customsYB_headerEdit($scope, $location, $http, $rootScope, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService, HistoryDataService) {

    //继承基类方法
    sale_customsYB_headerEdit = HczyCommon.extend(sale_customsYB_headerEdit, ctrl_bill_public);
    sale_customsYB_headerEdit.__super__.constructor.apply(this, [$rootScope, $scope, $location, $modal, $timeout, BasemanService, $state, localeStorageService, FormValidatorService]);
    //设置当前单据对象基本信息
    $scope.objconf = {
...
billmanControllers
    .controller('sale_customsYB_headerEdit', sale_customsYB_headerEdit)
