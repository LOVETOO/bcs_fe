/**市场费用项目*/
function mkt_object_header($scope, $location, $rootScope, $modal, $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService, BaseService) {
    $scope.data = {};
    $scope.data.currItem = {};
    $scope.conditions = {};
...
angular.module('inspinia')
    .controller('ctrl_mkt_object_header', mkt_object_header);