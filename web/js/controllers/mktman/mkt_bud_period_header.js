/**这是预算期间界面js*/
function mkt_bud_period_header($scope, $location, $rootScope, $modal, $timeout, $filter,BasemanService, notify, $state, localeStorageService, FormValidatorService,BaseService) {
    $scope.data = {};
    $scope.data.currItem = {};
    var searchData = {};
    var action = "";
...
app.controller('ctrl_mkt_bud_period_header', mkt_bud_period_header);
