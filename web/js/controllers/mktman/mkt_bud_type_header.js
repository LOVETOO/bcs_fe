/**这是预算类别界面js*/
function mkt_bud_type_header($scope, $location, $rootScope, $modal, $timeout, BasemanService, notify, $state, localeStorageService, FormValidatorService, BaseService) {
    $scope.data = {};
    $scope.data.currItem = {};
...
angular.module('inspinia')
    .controller('ctrl_mkt_bud_type_header', mkt_bud_type_header)
