 ...
 * 预算调整详情
 */
function mkt_bud_adjust_bill($scope, BaseService, $location, $rootScope, $modal, $timeout, BasemanService, notify, $state,
...
angular.module('inspinia')
    .controller('ctrl_mkt_bud_adjust_bill', mkt_bud_adjust_bill);