 ...
 * @since 2019-05-30
 */
define(['module', 'directiveApi', 'css!plugins/wui-date/wui.min'], function (module, directiveApi) {

	/**
	 * 指令
	 */
	wuiDateDirective.$inject = [];
	function wuiDateDirective() {
		return {
