    ...
    setStep: function(step,breakpoint) {
      ...
      $(this).each(function(i,n){
        ...
        if(1<=step && step<=$steps.length){
		  ...
		  break_scale = Math.round((breakpoint_len-step-1)*100/($steps.length-1))+break_scale;
          ...
          $progress.animate({
            ...
            speed: 1000,
              ...
              $steps.each(function(j,m){
                var _$m = $(m);
                var _j = j+1;
				if(_bpoint != -1 && _j < _bpoint && _j > step){
